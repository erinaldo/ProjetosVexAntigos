...
public partial class NotasFiscaisOcorrenciaFiltro : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {           
            ...
            if (!IsPostBack)
            {
                ...
                {
                    btnGerarReport.Attributes.Add("onClick", "FullWindow('frmRptEntregas.aspx?tipo=TELA&tit=" + Server.UrlEncode("Notas Fiscais com ocorrências") + "', 'NovaJanela2', 'yes')");
                    btnPDF.Attributes.Add("onClick", "FullWindow('frmRptEntregas.aspx?tipo=PDF&tit=" + Server.UrlEncode("Notas Fiscais com ocorrências") + "', 'NovaJanela22', 'yes')");
    ...
    private void CarregarGrid()
    {
        ...
        ssql.Append(" AND DOC.DATADEEMISSAO BETWEEN CONVERT(DATETIME, '" + DataConf[0] + "', 103) AND CONVERT(DATETIME, '" + DataConf[1] + "', 103) ");
