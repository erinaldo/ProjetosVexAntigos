<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frmSobraDetalhe.aspx.cs"
    Inherits="frmSobraDetalhe" Theme="Adm" EnableTheming="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="Server">
    <table style="width: 100%;" __designer:mapid="13af" border="0" cellpadding="0" cellspacing="0">
        ...
        <asp:UpdatePanel ID="uplDivi" runat="server">
            <ContentTemplate>
                <div id="dvEscolherCliente" runat="server" visible="false" style="position:absolute; top:30%; left:35%; width:400px">
                    <table class="table">
    ...
    <table cellpadding="1" cellspacing="1" class="table" width="99%">
        ...
        <tr>
            ...
            <td class="tdp">
                <asp:TextBox ID="txtI" runat="server" CssClass="txt" Width="99%"></asp:TextBox>
