...
//        SistranBLL.Usuario.LogBDBLL.GravarLog(ILusuario[0].UsuarioId, ILusuario[0].Login, "PESQUISOU " + Server.UrlDecode(Request.QueryString["opc"].ToString().ToUpper()), System.IO.Path.GetFileName(HttpContext.Current.Request.FilePath));
        ...
        foreach (DataRow item in dt.Rows)
        {
            ...
            PlaceHolder1.Controls.Add(new LiteralControl(@"<td class='tdpR' nowrap=nowrap  style='font-size:7pt;height:10px'>" + decimal.Parse(item["PESOBRUTO"].ToString()).ToString("#,0.000"))); 
            PlaceHolder1.Controls.Add(new LiteralControl(@"</td>"));
            ...
            PlaceHolder1.Controls.Add(new LiteralControl(@"<td class='tdpR' nowrap=nowrap  style='font-size:7pt;height:10px'>" + decimal.Parse(item["QUANTIDADEDENOTAS"].ToString()).ToString("#0"))); 
            PlaceHolder1.Controls.Add(new LiteralControl(@"</td>"));

            PlaceHolder1.Controls.Add(new LiteralControl(@"<td class='tdpR' nowrap=nowrap  style='font-size:7pt;height:10px'>" + decimal.Parse(item["FRETE"].ToString()).ToString("#,0.00"))); 
            PlaceHolder1.Controls.Add(new LiteralControl(@"</td>"));


            PlaceHolder1.Controls.Add(new LiteralControl(@"<td class='tdpR' nowrap=nowrap  style='font-size:7pt;height:10px'>" + decimal.Parse(item["FATURADO"].ToString()).ToString("#,0.00"))); 
            PlaceHolder1.Controls.Add(new LiteralControl(@"</td>"));

            PlaceHolder1.Controls.Add(new LiteralControl(@"<td class='tdpR' nowrap=nowrap  style='font-size:7pt;height:10px'>" + decimal.Parse(item["NAOFATURADO"].ToString()).ToString("#,0.00"))); 
            PlaceHolder1.Controls.Add(new LiteralControl(@"</td>"));



            
            PlaceHolder1.Controls.Add(new LiteralControl(@"<td class='tdpR' nowrap=nowrap  style='font-size:7pt;height:10px'>" + decimal.Parse(item["PAGO"].ToString()).ToString("#,0.00"))); 
            PlaceHolder1.Controls.Add(new LiteralControl(@"</td>"));

            PlaceHolder1.Controls.Add(new LiteralControl(@"<td class='tdpR' nowrap=nowrap  style='font-size:7pt;height:10px'>" +(decimal.Parse(item["FATURADO"].ToString()) - decimal.Parse(item["PAGO"].ToString())).ToString("#,0.00"))); 
            PlaceHolder1.Controls.Add(new LiteralControl(@"</td>"));
        ...
        PlaceHolder1.Controls.Add(new LiteralControl(@"<td class='tdpCabecalho' align='right' nowrap=nowrap style='font-size:7pt;font-weight:bold'>" + (Convert.ToDecimal(dt.Compute("SUM(faturado)", "")) - Convert.ToDecimal(dt.Compute("SUM(PaGO)", ""))).ToString("#000,0.00")));
        PlaceHolder1.Controls.Add(new LiteralControl(@"</td>"));
