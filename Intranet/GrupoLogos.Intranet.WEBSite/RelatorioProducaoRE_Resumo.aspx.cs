    ...
    private void Gerar()
    {
        ...
        Session["fim"] = txtF.Text;
            ...
            DataTable dtGeral;
                ...
                S += " WHERE EMISSAO BETWEEN '" + DateTime.Parse(txtI.Text).ToString("yyyy-MM-dd") + "' AND '" +  DateTime.Parse(txtF.Text).ToString("yyyy-MM-dd") + "' AND FLNOME <> 'VEX TRANSFERENCIA'  AND F.ATIVO='SIM'";
