...
public partial class frmhistoricopalletsDetalhe : System.Web.UI.Page
{
    ...
    protected void CarregarDados()
    {
		...
		*/
		...
		strsql += " (SELECT TOP 1 P.PESOBRUTO FROM PRODUTOEMBALAGEM PE  INNER JOIN PRODUTO P ON P.IDPRODUTO = PE.IDPRODUTO    WHERE PE.IDPRODUTOCLIENTE = PC.IDPRODUTOCLIENTE  ORDER BY PE.UNIDADEDOCLIENTE DESC) *UAL.SALDO PESOTOTAL,  F.NOME FILIAL, '01/11/2017' Data ";
		...
		strsql += " WHERE IDCDA IS NULL AND CONVERT(DATETIME, DATA, 103) = CONVERT(DATETIME, '01/11/2017', 103) ";
