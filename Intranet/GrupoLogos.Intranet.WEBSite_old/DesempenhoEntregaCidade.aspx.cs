...
>>>>>>> .r150
                ...
                btnGerarReport.Attributes.Add("onClick", "FullWindow('frmRptDesempenhoCidade.aspx?tipo=TELA&tit=" + Server.UrlEncode(Request.QueryString["opc"].ToString()) + "', 'NovaJanela2', 'yes')");
                btnPDF.Attributes.Add("onClick", "FullWindow('frmRptDesempenhoCidade.aspx?tipo=PDF&tit=" + Server.UrlEncode(Request.QueryString["opc"].ToString()) + "', 'NovaJanela22', 'yes')");
    ...
    protected void MontarTable()
    {
        ...
        DataTable dt = NotasFiscais.ListarDesempenhoEntregaCidade(Convert.ToDateTime(txtI.Text), Convert.ToDateTime(txtF.Text), Sistran.Library.FuncoesUteis.retornarClientesResumoFilial(true),DropDownList1.SelectedValue, DropDownList2.SelectedValue, Session["Conn"].ToString(), false);
