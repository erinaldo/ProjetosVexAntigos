<%@ page language="C#" masterpagefile="~/Site.master" autoeventwireup="true" inherits="Filtro, App_Web_filtro.aspx.cdcab7d2" theme="Adm" enabletheming="true" %>
        ...
        <table id="novatb" class="table" runat="server" cellpadding="1" cellspacing="0" width="100%">
            ...
            <tr valign="baseline">
                <td class="tdp" valign="middle">
                    <asp:TextBox ID="txtNf" runat="server" CssClass="txt" Width="150px" AutoPostBack="True"
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Button ID="btnGerarReport" runat="server" CssClass="button" Font-Names="Arial"
                                    Font-Size="7pt" Text="Relatório" Width="60px" />
                            </td>
                            <td>
