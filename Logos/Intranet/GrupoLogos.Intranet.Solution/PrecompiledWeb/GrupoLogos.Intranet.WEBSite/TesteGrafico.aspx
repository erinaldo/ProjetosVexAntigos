<%@ page language="C#" masterpagefile="~/Site.master" autoeventwireup="true" inherits="TesteGrafico, App_Web_testegrafico.aspx.cdcab7d2" theme="Adm" enabletheming="true" validaterequest="false" enableeventvalidation="false" %>
                            ...
                            <td valign="top" style="height: 16px">
                                ...
                                <asp:Chart ID="Chart1" runat="server" BorderlineWidth="0">
                                    <Series>
                                        ...
                                        <asp:Series ChartArea="ChartArea1" Name="Series4">
                                        </asp:Series>
                                    </Series>
                                    <ChartAreas>
                                        <asp:ChartArea Name="ChartArea1" BorderColor="Transparent">
                                            <AxisX LineColor="Transparent" LineDashStyle="NotSet">
                                            </AxisX>
                                        </asp:ChartArea>
                                    </ChartAreas>
                                    <Titles>
