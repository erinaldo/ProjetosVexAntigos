<%@ page language="C#" masterpagefile="~/Site.master" autoeventwireup="true" inherits="Intranet_frmCadTransportadora, App_Web_frmcadtransportadora.aspx.cdcab7d2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="Server">
    ...
    <table cellpadding="2" cellspacing="1" class="table" style="width: 100%" border="0">
        <tr>
            ...
            <td class="tdp" nowrap="nowrap" width="49%">
        ...
        <tr>
            <td class="tdp" nowrap="nowrap">
                Conta Contabil:</td>
            <td class="tdp" nowrap="nowrap">
                <asp:DropDownList ID="cboCC" runat="server" CssClass="cbo" Width="96%">
                </asp:DropDownList>
            </td>
            <td class="tdp" nowrap="nowrap">
                &nbsp;</td>
