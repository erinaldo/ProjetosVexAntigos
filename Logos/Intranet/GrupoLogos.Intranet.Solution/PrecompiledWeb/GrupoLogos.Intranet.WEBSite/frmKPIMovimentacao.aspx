<%@ page language="C#" masterpagefile="~/Site.master" autoeventwireup="true" inherits="frmKPIMovimentacao, App_Web_frmkpimovimentacao.aspx.cdcab7d2" theme="Adm" enabletheming="true" validaterequest="false" enableeventvalidation="false" %>
            ...
            <asp:Panel ID="pnlteste" runat="server" DefaultButton="Button1">
                ...
                <table id="novatb" class="table" runat="server" cellpadding="1" cellspacing="0" width="100%">
                    <tr valign="baseline">
                        ...
                        <td class="tdp"><asp:DropDownList runat="server" ID="cboCliente" CssClass="cbo" 
                                onselectedindexchanged="cboCliente_SelectedIndexChanged"></asp:DropDownList></td>
                        ...
                        <td class="tdp" nowrap="nowrap" valign="baseline" width="50%">
                            ...
                            &nbsp;<asp:Button ID="btnGerarExcel" runat="server" CssClass="button" 
                                Font-Names="arial" Font-Size="7pt" 
                                Text="Gerar Excel" Visible="False" />
                            </td>
                    </tr>
                </table>
                    ...
                    <table style="width: 100%" border="0">
                        <tr>
                            <td valign="top" style="height: 16px">
                                ...
                                <asp:GridView ID="GridView1" runat="server" Font-Names="Arial" Font-Size="8px" 
                                    BackColor="#F4F4F4">
                                    <AlternatingRowStyle BorderColor="White" BorderStyle="Solid" 
                                        BorderWidth="2px" />
                                    <HeaderStyle Font-Bold="True" BackColor="#999999" BorderStyle="Solid" 
                                        BorderWidth="1px" CssClass="tdpCabecalho" />
                                    <RowStyle Font-Names="Arial" Font-Size="8pt" BorderColor="White" 
                                        BorderStyle="Solid" BorderWidth="2px" CssClass="tdp" />
                                </asp:GridView>
                                <br />                               
