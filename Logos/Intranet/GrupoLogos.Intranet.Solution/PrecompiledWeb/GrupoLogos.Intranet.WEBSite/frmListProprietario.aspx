<%@ page language="C#" masterpagefile="~/Site.master" autoeventwireup="true" inherits="Intranet_frmListProprietario, App_Web_frmlistproprietario.aspx.cdcab7d2" enabletheming="True" theme="Adm" %>
                    ...
                    <MasterTableView AutoGenerateColumns="False">
                        ...
                        <Columns>
                            <telerik:GridTemplateColumn HeaderText="Código" UniqueName="TemplateColumn">
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink1" runat="server" Text='<%# Bind("IDPROPRIETARIO") %>' NavigateUrl='<% # "frmCadProprietario.aspx?idProprietario=" + Eval("IDPROPRIETARIO") %>'></asp:HyperLink>
                                </ItemTemplate>
