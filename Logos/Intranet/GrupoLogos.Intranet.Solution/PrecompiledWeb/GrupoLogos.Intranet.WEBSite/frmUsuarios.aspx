<%@ page language="C#" masterpagefile="~/Site.master" autoeventwireup="true" inherits="frmUsuarios, App_Web_frmusuarios.aspx.cdcab7d2" theme="Adm" enabletheming="true" %>
    ...
    <telerik:RadTabStrip ID="RadTabStrip1" runat="server" MultiPageID="rmp" SelectedIndex="0"
        ...
        <Tabs>
            <telerik:RadTab runat="server" PageViewID="rpvUsuarios" Text="Usuários" 
                Selected="True" />
            <telerik:RadTab runat="server" PageViewID="rpvPerfis" Text="Perfis" />
        </Tabs>
    </telerik:RadTabStrip>
    <telerik:RadMultiPage ID="rmp" runat="server" SelectedIndex="0" BackColor="White"
                        ...
                        <telerik:RadGrid ID="RadGridUsuarios" runat="server" AllowPaging="True" AllowSorting="True"
                            ...
                            <MasterTableView BorderColor="#CCCCCC" BorderWidth="1px" CellPadding="0" GridLines="Both">
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn DataField="Senha" EmptyDataText="&amp;nbsp;" HeaderStyle-HorizontalAlign="left"
                                        HeaderText="Senha" ItemStyle-HorizontalAlign="left" UniqueName="column6">
                                        <HeaderStyle HorizontalAlign="left" />
                                        <ItemStyle HorizontalAlign="left" />
                                    </telerik:GridBoundColumn>
