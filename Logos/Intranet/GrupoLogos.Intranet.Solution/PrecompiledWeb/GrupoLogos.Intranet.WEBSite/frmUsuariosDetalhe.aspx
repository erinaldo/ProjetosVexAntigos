<%@ page language="C#" masterpagefile="~/SiteDetalheFull.master" autoeventwireup="true" inherits="frmUsuariosDetalhe, App_Web_frmusuariosdetalhe.aspx.cdcab7d2" theme="Adm" enabletheming="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="Server">
    ...
    <div id="dvEscolherUsuario" runat="server" visible="false" style="position: absolute;
        top: 10%; left: 33%; width: 400px">
        <table class="table">
            ...
            <tr>
                ...
                <td class="tdp" nowrap="nowrap" style="width: 90%">
                    <asp:TextBox ID="txtFiltroNomeCliente" runat="server" CssClass="txt" Width="99%"></asp:TextBox>
                </td>
                <td class="tdp" nowrap="nowrap" style="width: 1%">
                    <asp:Button ID="btnPesquisarFiltroUsuario" runat="server" CssClass="button" Font-Size="9pt"
                        OnClick="btnPesquisrFiltro_Click" Text="Pesquisar" Width="100px" CausesValidation="False" />
                </td>
            </tr>
            <tr>
                <td class="tdp" colspan="3">
            ...
            <tr>
                <td class="tdpR" colspan="3">
                    <asp:Button ID="btnConfirmarUsuario" runat="server" CssClass="button" Font-Size="9pt"
                        OnClick="btnConfirmarUsuario_Click" Text="Confirmar" Width="100px" CausesValidation="False" />
                </td>
            </tr>
        </table>
    </div>
