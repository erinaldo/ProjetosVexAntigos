<%@ page language="C#" masterpagefile="~/Site.master" autoeventwireup="true" inherits="frmhistoricopallets, App_Web_frmhistoricopallets.aspx.cdcab7d2" theme="Adm" enabletheming="true" %>
                                    ...
                                    <td>
                                        <asp:UpdatePanel ID="x" runat="server">
                                            <ContentTemplate>
                                                ...
                                                <input onclick="javascript:window.open('frmgdrExcelSobras.aspx'); return false; "
                                                    type="button" value="Gerar Excel" class="button" />
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                    </td>
                                </tr>
