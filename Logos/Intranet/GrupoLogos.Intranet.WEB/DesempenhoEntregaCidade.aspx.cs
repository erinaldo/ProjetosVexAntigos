...
public partial class DesempenhoEntregaCidade : System.Web.UI.Page
{
    ...
    protected void MontarTable()
    {
        ...
        DataTable dt = NotasFiscais.ListarDesempenhoEntregaCidade(Convert.ToDateTime(txtI.Text), Convert.ToDateTime(txtF.Text), Sistran.Library.FuncoesUteis.retornarClientesResumoFilial(),DropDownList1.SelectedValue, DropDownList2.SelectedValue, Session["Conn"].ToString());
