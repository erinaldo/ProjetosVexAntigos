...
public partial class DesempenhoEntregaDia : System.Web.UI.Page
{
    ...
    protected void MontarTable()
    {
        ...
        DataTable dt = NotasFiscais.ListarDesempenhoEntregaDia(Convert.ToDateTime(txtI.Text), Convert.ToDateTime(txtF.Text), Sistran.Library.FuncoesUteis.retornarClientesResumoFilial(), Session["Conn"].ToString());
        PlaceHolder1.Controls.Clear();
        DataTable dtNaoEntregues = NotasFiscais.ListarDesempenhoEntregaDiaNaoEntregue(Convert.ToDateTime(txtI.Text), Convert.ToDateTime(txtF.Text), Sistran.Library.FuncoesUteis.retornarClientesResumoFilial(), Session["Conn"].ToString());
