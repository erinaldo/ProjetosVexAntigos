...
public partial class DesempenhoEntregaFilial : System.Web.UI.Page
{
    ...
    protected void MontarTable()
    {
        ...
        DataTable dt = NotasFiscais.ListarDesempenhoEntregaFilial(Convert.ToDateTime(txtI.Text), Convert.ToDateTime(txtF.Text), Sistran.Library.FuncoesUteis.retornarClientesResumoFilial(), Session["Conn"].ToString());
