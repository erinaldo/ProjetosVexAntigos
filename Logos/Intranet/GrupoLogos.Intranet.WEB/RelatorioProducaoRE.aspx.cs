...
public partial class RelatorioProducaoRE : System.Web.UI.Page
{
    ...
    private void Gerar()
    {
        dtTodosOsDados = Sistran.Library.GetDataTables.RetornarDataSetWS("EXEC GERAR_PRODUCAO_RE '" + DateTime.Parse(txtI.Text).ToString("dd/MM/yyyy") + "', '" + DateTime.Parse(txtF.Text).ToString("dd/MM/yyyy") + "'", Sistran.Library.Robo.Robo.RetornarStringBaseAntiga()).Tables[0];
