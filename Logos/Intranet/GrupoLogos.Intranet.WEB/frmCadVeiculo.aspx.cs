...
public partial class Intranet_frmCadVeiculo : System.Web.UI.Page
{
  ...
  //          if (!catPerm.Contains(catMot.Trim()) || catMot == "")
    //            throw new Exception("O Motorista selecionado possui habilitação [" + catMot + "], o tipo de veículo selecionado só permite(m):["+ catPerm +"]" );
