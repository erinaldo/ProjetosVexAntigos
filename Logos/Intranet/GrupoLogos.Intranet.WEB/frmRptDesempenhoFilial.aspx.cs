...
public partial class frmRptDesempenhoFilial : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            SistranBLL.Usuario.LogBDBLL.GravarLog(ILusuario[0].UsuarioId, ILusuario[0].Login, "GEROU O RELATÓRIO DESEMPENHO POR FILIAL", System.IO.Path.GetFileName(HttpContext.Current.Request.FilePath));
