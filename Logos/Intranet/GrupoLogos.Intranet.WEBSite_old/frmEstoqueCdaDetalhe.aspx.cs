...
public partial class frmEstoqueCdaDetalhe : System.Web.UI.Page
{
    #region Events
    ...
    protected void CarregarDados()
    {
        ...
        string strsql = "exec RETORNARPOSICAOCDAONLINE " + Request.QueryString["idcliente"];
        ...
        ExportToExcel(dt, "cda_dia"+ DateTime.Now.ToString("yyyyMMdd"));
