...
//           SistranBLL.Usuario.LogBDBLL.GravarLog(ILusuario[0].UsuarioId, ILusuario[0].Login, "ACESSOU " + lblTitulo.Text, System.IO.Path.GetFileName(HttpContext.Current.Request.FilePath));           
    ...
    protected void RadGrid16_ItemCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
    {
        ...
        {
            List<SistranMODEL.Usuario> ILusuario = (List<SistranMODEL.Usuario>)Session["USUARIO"];
            Sistran.Library.GetDataTables.ExecutarSemRetorno("UPDATE SOBRA SET DATAFINALIZACAO=GETDATE(), IDUSUARIOBAIZADO=" + ILusuario[0].UsuarioId + ", FINALIZADO='SIM' WHERE IDSOBRA=" + e.CommandName.ToString(), HttpContext.Current.Session["Conn"].ToString());
            CarregarGrid();
        }
    }
    ...
    protected void RadGridUsuarios_PageSizeChanged(object source, Telerik.Web.UI.GridPageSizeChangedEventArgs e)
    {
        CarregarGrid();
    }
    protected void RadGridUsuarios_SortCommand(object source, Telerik.Web.UI.GridSortCommandEventArgs e)
    {
        CarregarGrid();
    }
    protected void RadGridUsuarios_PageIndexChanged(object source, Telerik.Web.UI.GridPageChangedEventArgs e)
    {
        CarregarGrid();
    }
