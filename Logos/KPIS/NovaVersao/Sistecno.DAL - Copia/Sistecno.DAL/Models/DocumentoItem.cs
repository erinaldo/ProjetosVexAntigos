...
namespace Sistecno.DAL.Models
{
    public partial class DocumentoItem
    {
        ...
        {
            this.DocumentoItemComplementoes = new List<DocumentoItemComplemento>();
            this.DocumentoItemEmpenhadoes = new List<DocumentoItemEmpenhado>();
            this.DocumentoItemLabelPickings = new List<DocumentoItemLabelPicking>();
            ...
            this.RomaneioDocumentoItems = new List<RomaneioDocumentoItem>();
        }
        ...
        public Nullable<int> IdProdutoFornecedor { get; set; }
        public Nullable<decimal> BaseDoICMSSubst { get; set; }
        public Nullable<decimal> PerMargValorICMSSubst { get; set; }
        public Nullable<decimal> pFCPUFDest { get; set; }
        public Nullable<decimal> pICMSUFDest { get; set; }
        ...
        public virtual ICollection<DocumentoItemComplemento> DocumentoItemComplementoes { get; set; }
        public virtual ICollection<DocumentoItemEmpenhado> DocumentoItemEmpenhadoes { get; set; }
        public virtual ICollection<DocumentoItemLabelPicking> DocumentoItemLabelPickings { get; set; }
        ...
        public virtual ICollection<RomaneioDocumentoItem> RomaneioDocumentoItems { get; set; }
    }
}
