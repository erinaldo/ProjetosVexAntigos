...
{
    public class DOCUMENTOPEDIDOMap : EntityTypeConfiguration<DOCUMENTOPEDIDO>
    {
        public DOCUMENTOPEDIDOMap()
        {
            // Primary Key
            ...
            this.Property(t => t.DATADERCREGISTRO).HasColumnName("DATADERCREGISTRO");
            this.Property(t => t.DATADOPROCESSAMENTO).HasColumnName("DATADOPROCESSAMENTO");
        }
    }
}
