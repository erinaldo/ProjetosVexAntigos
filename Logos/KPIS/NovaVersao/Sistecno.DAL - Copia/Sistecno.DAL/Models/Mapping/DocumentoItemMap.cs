...
{
    public class DocumentoItemMap : EntityTypeConfiguration<DocumentoItem>
    {
        public DocumentoItemMap()
        {
            // Primary Key
            this.HasKey(t => t.IDDocumentoItem);
            ...
            this.Property(t => t.IdProdutoFornecedor).HasColumnName("IdProdutoFornecedor");
            this.Property(t => t.BaseDoICMSSubst).HasColumnName("BaseDoICMSSubst");
            this.Property(t => t.PerMargValorICMSSubst).HasColumnName("PerMargValorICMSSubst");
            this.Property(t => t.pFCPUFDest).HasColumnName("pFCPUFDest");
            this.Property(t => t.pICMSUFDest).HasColumnName("pICMSUFDest");
