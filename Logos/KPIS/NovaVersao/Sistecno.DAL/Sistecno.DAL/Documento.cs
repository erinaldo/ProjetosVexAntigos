...
namespace Sistecno.DAL
{
    public class Documento
    {
        ...
        public DAL.Models.Documento Retornar(DAL.Models.Documento doc, string cnx)
        {
            ...
            var query = context.Documento.FirstOrDefault(p => p.TipoDeDocumento == doc.TipoDeDocumento
                                                  & p.Numero == doc.Numero
                                                  & p.Serie == doc.Serie
                                                  & p.AnoMes == doc.AnoMes
        ...
        public DAL.Models.Documento RetornarVolumes(int idDocumento, string cnx)
        {
            ...
            context.Database.Connection.ConnectionString = cnx;
            context.Database.Connection.Open();
            var query = context.Documento.FirstOrDefault(p => p.IDDocumento == idDocumento);
            context.Database.Connection.Close();
            return query;
        }
        ...
        public int GravarDocumentoImportacaoXml(DAL.Models.Documento doc, string cnx)
        {
            ...
            try
            {
                ...
                {
                    var oC = context.Documento.First(i => i.IDDocumento == doc.IDDocumento);
                ...
                foreach (var item in doc.DocumentoObservacao)
                {
                    if (item.IDDocumentoObservacao == 0)
                    {
                        ...
                        context.DocumentoObservacao.Add(obs);
                        context.SaveChanges();
                    }
                    else
                    {
                        var o = context.DocumentoObservacao.First(i => i.IDDocumentoObservacao == item.IDDocumentoObservacao);
                ...
                context.DocumentoAguardandoCTRC.Add(cctrc);
                context.SaveChanges();
                ...
                context.DocumentoFilial.Add(ddf);
                context.SaveChanges();
            ...
            if (documento.IDDocumento == 0)
            {
                ...
                try
                {
                    ...
                    //{
                        ...
                        context.DocumentoFilial.Add(docfil);
                        context.SaveChanges();
        ...
        public class Frete
        {
            public DAL.Models.DocumentoFrete Retornar(int iddocumento, string cnx)
            {
                ...
                context.Database.Connection.ConnectionString = cnx;
                context.Database.Connection.Open();
                var query = context.DocumentoFrete.FirstOrDefault(p => p.IDDocumento == iddocumento);
