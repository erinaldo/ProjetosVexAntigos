<%@ Page Title="" Language="C#" MasterPageFile="~/mpPrograma.Master" AutoEventWireup="true" CodeBehind="WEB0002.aspx.cs" Inherits="Sistecno.UI.Web.WEB0002" %>
                        ...
                        <div class="jarviswidget jarviswidget-color-blueDark jarviswidget-sortable" id="wid-id-0" data-widget-editbutton="false">
                            ...
                            <div>
                                ...
                                <div id="dvbot" style="width: auto; position: absolute; top: 6px; left: 70%; z-index: 1" runat="server">
                                    ...
                                    <a class="DTTT_button" id="A1" tabindex="0" aria-controls="datatable_tabletools" href="WEB0002.aspx?opc=&acao=novo&id=0"><span>Novo</span>
                                ...
                                <div id="dvManut" style="min-height: 400px" runat="server" visible="false">
                                    ...
                                    <%--<div id="dvValida" runat="server" visible="false" class="has-error">--%>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                                ...
                                                                <asp:UpdatePanel ID="upl" runat="server">
                                                                    <ContentTemplate>
                                                                        <asp:TextBox ID="txtCNPJCadastro" runat="server" class="form-control input-xs" MaxLength="20" AutoPostBack="True" OnTextChanged="txtCNPJCadastro_TextChanged"></asp:TextBox>
                                                                    </ContentTemplate>
                                                                </asp:UpdatePanel>
                                                            </div>
