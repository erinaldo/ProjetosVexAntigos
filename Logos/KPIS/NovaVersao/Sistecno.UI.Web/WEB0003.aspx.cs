...
{
    public partial class WEB0003 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                DataTable dt = new Sistecno.BLL.Cadastro.Proprietario().Retornar(null, cnx);
                CriarGrid(dt);
        ...
        {
            ph.Controls.Clear();
            ph.Controls.Add(new LiteralControl(GradeDeDados.CriarGrid(dt, "WEB0003.ASPX", Request.QueryString["opc"])));
        }
        ...
        private void Pesquisar_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt = new Sistecno.BLL.Cadastro.Proprietario().Retornar(parPesq, cnx);
            CriarGrid(dt);
        }
        ...
        {
            Response.Redirect("web0002.aspx?opc="+Request.QueryString["opc"], false);
        }
        ...
        protected void btnConfirmar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Sistecno.DAL.Models.Proprietario oP = new Sistecno.DAL.Models.Proprietario();
                oP.IDProprietario = oC.IDCadastro;

                DataTable dtContato = (DataTable)Session["dtContato"];
                new Sistecno.BLL.Cadastro().Gravar(oC, dtContato, oP, new Sistecno.DAL.BD.ConexaoPrincipal(Session["CNX"].ToString()).CxPrincipal);
                Response.Redirect("WEB0003.aspx?opc="+Request.QueryString["opc"], false);
        ...
        protected void txtCNPJCadastro_TextChanged(object sender, EventArgs e)
        {
            ...
            if (Sistecno.BLL.Helpers.Util.Validacoes.CnpjValido(c) || Sistecno.BLL.Helpers.Util.Validacoes.CpfValido(c))
            {
                ...
                if (dt.Rows.Count > 0)
                    Response.Redirect("WEB0003.ASPX?acao=editar&id=" + dt.Rows[0]["CODIGO"].ToString(), false);
                else
                    txtCNPJCadastro.Focus();
            }
            else
