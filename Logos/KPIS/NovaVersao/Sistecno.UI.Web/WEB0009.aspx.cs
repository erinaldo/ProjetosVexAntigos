...
{
    public partial class WEB0009 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            dtrPesquisaGenericaRemetente.evChamarEvento += new UC.dtrPesquisaGenerica.delChamarEvento(ExecutarEventoDestinatario);
           // dtrPesquisaGenericaCliente.evChamarEvento += new UC.dtrPesquisaGenerica.delChamarEvento(ExecutarEventoCliente);
            //dtrPesquisaGenericaDetinatario.evChamarEvento += new UC.dtrPesquisaGenerica.delChamarEvento(ExecutarEvento);
        ...
        private void ExecutarEventoCliente()
        {
            //retorna os dados do registro escolhido na pesquisa(grid) no filtro
            hdICliente.Value = dtrPesquisaGenericaCliente.ret;           

            Sistecno.BLL.Cadastro c = new Sistecno.BLL.Cadastro();
            Sistecno.DAL.Models.Cadastro cad = c.RetornarTabela(int.Parse(hdICliente.Value), cnx);

            txtPbCnpj_2.Text = cad.CnpjCpf;
            txtPbRazaoSocial_2.Text = cad.RazaoSocialNome;
            txtPbId_2.Text = dtrPesquisaGenericaCliente.ret;
            ...
            HiddenField lblId = (HiddenField)dtrPesquisaGenericaRemetente.FindControl("lblId");

            if (lblId.Value != "")
                lblId.Value = "";
        }

        public void ExecutarEventoDestinatario()
        {
            hdIdRemetente.Value = dtrPesquisaGenericaRemetente.ret;
            ...
            txtPbId_0.Text = dtrPesquisaGenericaRemetente.ret;
        ...
        //    txtPbId_1.Text = dtrPesquisaGenericaDetinatario.ret;
        //    txtPbIe_1.Text = cad.InscricaoRG;
        ...
        private void CamposPesquisaGenRemetente()
        {
            ...
            f.Add(new Sistecno.BLL.Helpers.CamposSearch("CPF", "CNPJCPF_", "100", "txt", "CPF", "", null));
            f.Add(new Sistecno.BLL.Helpers.CamposSearch("NOME", "RAZAOSOCIALNOME", "150", "", "", "", null));
            dtrPesquisaGenericaRemetente.camposPesquisa = f;
            ...
            //define lista de restrições, por exemplo filial / empresa.
            // porem o campotem que estar definido no select acima
            dtrPesquisaGenericaRemetente.restricoesPesquisa = null;

            //passa o sql para o controle
            dtrPesquisaGenericaRemetente.sqlBasico = sql;

            //comando para montar os campos
            dtrPesquisaGenericaRemetente.MontarCampos();
        }
