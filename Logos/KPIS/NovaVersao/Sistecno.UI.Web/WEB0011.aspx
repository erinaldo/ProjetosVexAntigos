<%@ Page Title="" Language="C#" MasterPageFile="~/mpPrograma.Master" AutoEventWireup="true" CodeBehind="WEB0011.aspx.cs" Inherits="Sistecno.UI.Web.WEB0011" %>
                            ...
                            <div class="jarviswidget jarviswidget-color-blueDark jarviswidget-sortable" id="wid-id-0" data-widget-editbutton="false">
                                ...
                                <div>
                                    ...
                                    <div id="dvbot" style="width: auto; position: absolute; top: 6px; left: 70%; z-index: 1" runat="server">
                                        ...
                                        <a class="DTTT_button" id="A1" tabindex="0" aria-controls="datatable_tabletools" href="WEB0011.aspx?acao=novo&id=0&opc="><span>Novo</span>
                                ...
                                <header role="heading">
                                    ...
                                    <ul class="nav nav-tabs pull-right in" id="myTab">
                                        <li class="active" id="s1i">
                                            <a data-toggle="tab" href="#s1" aria-expanded="true"><span class="hidden-mobile hidden-tablet">CTE</span></a>
                                        </li>

                                        <li class="" id="s2i">
                                            <a data-toggle="tab" href="#s2" aria-expanded="true"><span class="hidden-mobile hidden-tablet">ENVIO</span></a>
                                        </li>


                                        <li class="" id="s3i">
                                            <a data-toggle="tab" href="#s3" aria-expanded="true"><span class="hidden-mobile hidden-tablet">DACTE-XML/PDF</span></a>
                                        </li>
                                                            ...
                                                            <div class="form-group">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-1" style="text-align: right">
                                                                        <asp:Button ID="btnAdicionarMeioContato" runat="server" Text="Adicionar" class="btn btn-primary btn-xs" />
