<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmPreLogin.aspx.cs" Inherits="Sistecno.UI.Web.frmPreLogin" %>
    ...
    <header id="header">
        ...
        <div id="logo-group">
            <span id="logo" style="margin-top: 1px;">
                <asp:Image ID="imgLogo" runat="server"  style="height: 60px; width: auto;"/>
            </span>
        </div>
        ...
        <div id="content" class="container">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-7 col-lg-8 hidden-xs hidden-sm">
                    <h1 class="txt-color-blue login-header-big">
                                 <asp:Label ID="lblsecao1" runat="server" Text="Texto de Exemplo"></asp:Label>

                    </h1>
                    <div class="hero">

                        <div class="pull-left login-desc-box-l">
                            <h4 class="paragraph-header"><asp:Label ID="lblSecao1Texto" runat="server" Text="Texto de Exemplo"></asp:Label></h4>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            <h5 class="about-heading">
                                <asp:Label ID="lblSecao2" runat="server" Text="Label"></asp:Label></h5>
                            <p>
                                 <asp:Label ID="lblSecao2Texto" runat="server" Text="Texto de Exemplo"></asp:Label>
                            </p>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            <h5 class="about-heading"> 
                                <asp:Label ID="lblSecao3" runat="server" Text="Label"></asp:Label>

                            </h5>
                            <p>
                               <asp:Label ID="lblSecao3Texto" runat="server" Text="Label"></asp:Label>
