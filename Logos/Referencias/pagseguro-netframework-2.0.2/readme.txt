PagSeguro .NET Library - version 2.0.2
 
Please refer to the online documentation:
 
 - How to use PagSeguro as a payment solution for your website using the PagSeguro .NET Library:
    https://pagseguro.uol.com.br/v2/guia-de-integracao/tutorial-da-biblioteca-pagseguro-netframework.html
 
 - Class library documentation:
    https://pagseguro.uol.com.br/v2/guia-de-integracao/documentacao-da-biblioteca-pagseguro-netframework.html
