...
namespace Robo.Email.Notas.Solutions.Windows.Testes
{
    public partial class Form1 : Form
    {
        ...
        public void GravarExcecucao(string NomeTimer)
        {
            try
            {
                string sql = "insert into UltimaExecucaoRobo values (getDate(), '"+NomeTimer+"'); select 1";
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    minRod = DateTime.Now.Minute;
                    Thread t = new Thread(twx);
                    t.Start();
                    GravarLog("Rodou: " + DateTime.Now.ToString(), "");
                ...
                if (emailReBDAntigo.Length > 5)
                {
                    ...
                    emailTotal += "<br>Entrega RE: <br> Emais: " + emailReBDAntigo.Replace(";", "<br>");
                }
                ...
                if (emailPainelFaturamento.Length > 5)
                {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            //MontarEmailRE_Mensal_BaseNovaLogos("moises@sistecno.com.br", DateTime.Parse("01/09/2015"), DateTime.Parse("30/09/2015"));
            //MontarEmailRE_Mensal_BaseNovaLogos("moises@sistecno.com.br;sylvia@logospromocional.com.br;edvaldo@sistecno.com.br", DateTime.Parse("01/08/2015"), DateTime.Parse("31/08/2015"));
            //EnviarEmailPd();


            //List<DadosOperacaoCliente> Barbosa = RetornarClientesBarbosa();
            //enviarOperacaoCliente("moises@sistecno.com.br", Barbosa);


            MontarEmailRERegiao_BaseNovaLogos("moises@sistecno.com.br", true);
            //  MontarEmailRERegiao_Mensal_BaseNovaLogos("moises@sistecno.com.br");
            ...
            try
            {
                ...
                if (d.Rows.Count > 0)
                {
                    for (int i = 0; i < d.Rows.Count; i++)
                    {
                        ...
                        // message.Subject = d.Rows[i]["Assunto"].ToString();
                        // string MsgTipo = MediaTypeNames.Text.Html;
                        string cont = "";
                        cont = d.Rows[i]["Conteudo"].ToString();
                        // AlternateView alternate = AlternateView.CreateAlternateViewFromString(cont, System.Text.Encoding.GetEncoding(1252), MsgTipo);
                        // message.AlternateViews.Add(alternate);

                        //// client.Credentials = new System.Net.NetworkCredential("website@logospromocional.com.br", "logos2014");
                        // client.Credentials = new System.Net.NetworkCredential("sistema@grupologos.com.br", "logos0902");
                        // client.Host = "mail.grupologos.com.br";
                        // //client.Host = "mail.grupologos.com.br";
                        // client.Port = 587;
                        ...
                        desti = desti.Replace(",", ";");
                        Sistran.Library.EnviarEmails.EnviarEmail(desti, "sistema@grupologos.com.br", d.Rows[i]["Assunto"].ToString(), cont, "mail.grupologos.com.br", "logos0902", "Grupo Logos - Logos Promocional <website@logospromocional.com.br>");
        ...
        private void MontarEmailRE_BaseNovaLogos(string email)
        {
            DataTable dtGeral = Sistran.Library.GetDataTables.RetornarDataSetWS("EXEC PRC_RE_LISTAR ", Sistran.Library.Robo.Robo.RetornarStringBaseNovaLogos()).Tables[0];
        ...
        private void MontarEmailRERegiao_BaseNovaLogos(string email, bool mensal)
        {
            DataTable dtGeral;

            if (mensal == false)
                dtGeral = Sistran.Library.GetDataTables.RetornarDataSetWS("EXEC PRC_RESULTADO_RE null, '2015-09-01', '2015-09-01', 1,  'dt'  ", Sistran.Library.Robo.Robo.RetornarStringBaseNovaLogos()).Tables[0];
            else
                dtGeral = Sistran.Library.GetDataTables.RetornarDataSetWS("SELECT * FROM FACE_RE  with (NOLOCK) WHERE EMISSAO BETWEEN '2015-10-01' AND '2015-10-15'  ", Sistran.Library.Robo.Robo.RetornarStringBaseNovaLogos()).Tables[0];



            //DataTable dtGeral = Sistran.Library.GetDataTables.RetornarDataSetWS("EXEC PRC_RESULTADO_RE null, '" + DateTime.Now.ToString("yyyy-MM-dd") + "', '" + DateTime.Now.ToString("yyyy-MM-dd") + "', 1,  'dt'  ", Sistran.Library.Robo.Robo.RetornarStringBaseNovaLogos()).Tables[0];
            ...
            DataView view = new DataView(dtGeral);
            DataTable dt = view.ToTable(true, "FLNOME", "IMPOSTO", "TAXAADMINISTRATIVA", "TAXADETRANFERENCIA", "SEGURO");
            dt.Columns.Add("LucroTotal", typeof(decimal));
            ...
            if (mensal == false)
                Sistran.Library.EnviarEmails.EnviarEmail(email, "sistema@grupologos.com.br", "Aviso: RELATÓRIO DE PRODUÇÃO POR RELAÇÃO DE ENTREGA(Diário/Região)", html, "mail.grupologos.com.br", "logos0902", "RELATÓRIO DE PRODUÇÃO POR RELAÇÃO DE ENTREGA");
            else
                Sistran.Library.EnviarEmails.EnviarEmail(email, "sistema@grupologos.com.br", "Aviso: RELATÓRIO DE PRODUÇÃO POR RELAÇÃO DE ENTREGA(Mensal/Região)", html, "mail.grupologos.com.br", "logos0902", "RELATÓRIO DE PRODUÇÃO POR RELAÇÃO DE ENTREGA");
                ...
                for (int iCli = 0; iCli < OperacaoCliente.Count; iCli++)
                {
                    ...
                    for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                    {
                        ...
                        if (i == 0)
                        {
                            ...
                            sstr += "<tr'>";
                            //                            sstr += "<td class='tdpCenter'  align='center' nowrap=nowrap style='font-size:8pt;width:1%'>" + DateTime.Parse(ds.Tables[0].Rows[i]["DATADEEMISSAO"].ToString()).ToString("dd/MM/yyyy") + "</td>";
                            ...
                            //sstr += "<td class='tdpR'  align='right' nowrap=nowrap style='font-size:7pt;width:1%'>" + decimal.Parse(ds.Tables[0].Rows[i]["PESOSEMDT"].ToString()).ToString("#,0") + "</td>";
                        ...
                        //sstr += "<tr'>";
                        //sstr += "<td class='tdpCenter'  align='center' nowrap=nowrap style='font-size:8pt;width:1%'>" + DateTime.Parse(ds.Tables[0].Rows[i]["DATADEEMISSAO"].ToString()).ToString("dd/MM/yyyy") + "</td>";
                        //sstr += "<td class='tdpR'  align='right' nowrap=nowrap style='font-size:7pt;width:1%'>" + int.Parse(ds.Tables[0].Rows[i]["NFEMITIDAS"].ToString()) + "</td>";
                        //sstr += "<td class='tdpR'  align='right' nowrap=nowrap style='font-size:7pt;width:1%'>" + decimal.Parse(ds.Tables[0].Rows[i]["PESOEMITIDAS"].ToString()).ToString("#,0") + "</td>";

                        //sstr += "<td class='tdpR'  align='right' nowrap=nowrap style='font-size:7pt;width:1%'>" + int.Parse(ds.Tables[0].Rows[i]["SEMDT"].ToString()) + " </td>";
                        //sstr += "<td class='tdpR'  align='right' nowrap=nowrap style='font-size:7pt;width:1%'>" + decimal.Parse(ds.Tables[0].Rows[i]["PESOSEMDT"].ToString()).ToString("#,0") + "</td>";



                        //sstr += "<td class='tdpR'  align='right' nowrap=nowrap style='font-size:7pt;width:1%'>" + int.Parse(ds.Tables[0].Rows[i]["COMDT"].ToString()) + "</td>";
                        //sstr += "<td class='tdpR'  align='right' nowrap=nowrap style='font-size:7pt;width:1%'>" + int.Parse(ds.Tables[0].Rows[i]["ENTREGUES"].ToString()) + "</td>";
                        //sstr += "<td class='tdpR'  align='right' nowrap=nowrap style='font-size:7pt;width:1%'>" + int.Parse(ds.Tables[0].Rows[i]["NAOENTREGUES"].ToString()) + "</td>";
                        //decimal x = decimal.Parse(ds.Tables[0].Rows[i]["PEC_ENTREGAS"].ToString());
                        //string s = "tdpR";


                        //sstr += "<td class='" + s + "'  align='right' nowrap=nowrap style='font-size:7pt;width:1%'>" + decimal.Parse(ds.Tables[0].Rows[i]["PEC_ENTREGAS"].ToString()).ToString("#0.00") + "</td>";
                        //sstr += "</tr>";
