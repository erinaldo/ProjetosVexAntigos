...
namespace SistranBLL
{
    ...
    {
        public static List<SistranMODEL.Usuario> Login(string usuariologin, string usuarioSenha, string Conn)
        {
            try
            {
                ...
                else
                {
                    ...
                    List<SistranMODEL.Usuario> ILusuario = SistranDAO.Usuario.RetornaUsuarioLogin_Alone(usuariologin, usuarioSenha, Conn);
        ...
        public static List<SistranMODEL.Usuario> Login_Alone(string usuariologin, string usuarioSenha, string Conn)
        {
            try
            {
                if (string.IsNullOrEmpty(usuariologin) || string.IsNullOrEmpty(usuarioSenha))
        ...
        {
            public static void GravarLog(int idUser, string login, string acao, string pagina)
            {
                SistranDAO.Usuario.LogBDDAO.GravarLog(idUser, login, acao, pagina);
            }
        }
