...
namespace SistranDAO
{
    public class Veiculo
    {
        public DataTable ListarMonitoramento(string data, string filiais, string cliente, string ordem, string Conn)
        {
            ...
            strsql.Append(" Select    fil.Nome filial, Dt.Numero,   Dt.Numero IdDt,   Dt.Emissao,   Vei.Placa, ");
            ...
            strsql.Append(" and (Doc.IdRemetente in (@cliente) or Doc.IDDestinatario in(@cliente) or IDCliente in(@cliente)) ");
            strsql.Append(" Group By    fil.Nome, Dt.Numero,   Dt.IdDt,   Dt.Emissao,   Vei.Placa,  Cad.RazaoSocialNome  ");
