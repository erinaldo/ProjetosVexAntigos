...
namespace SistranBLL
{
    public sealed class NotasFiscais
    {
        ...
        {
            return SistranDAO.NotasFiscais.ListarDesempenhoEntregaCidade(Ini, Fim, clientes, ordem,ordem2, Conn);
        }

        public static DataTable ListarResumoPorFilial(DateTime Ini, DateTime Fim, string clientes, string Conn, Sistran.Library.Enuns.tipoReportResumoFilial tipo)
        {
            DataTable dttemp = SistranDAO.NotasFiscais.ListarResumoPorFilial(Ini, Fim, clientes, Conn, tipo);
