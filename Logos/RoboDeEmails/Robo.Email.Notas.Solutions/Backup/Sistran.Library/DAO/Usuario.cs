...
namespace SistranDAO
{
    public sealed class Usuario
    {
        ...
        public static List<SistranMODEL.Usuario> RetornaUsuarioLogin_Alone(string usuariologin, string usuarioSenha, string Conn)
        {
            ...
            strsql.Append(" ISNULL(CA.RazaoSocialNome, CA.FantasiaApelido) + ' - ' + ISNULL(CA.InscricaoRG, CA.CnpjCpf) as RazaoSocialNome ");
        ...
        {
            StringBuilder strsql = new StringBuilder();
            strsql.Append(" SELECT DISTINCT U.IDUsuario, U.IDCadastro, U.Login, U.Nome, CCE.Endereco AS EMAIL, C.CnpjCpf, U.Ativo , U.IDPerfil, (SELECT TOP 1 UU.Nome FROM Usuario UU WHERE U.IDPerfil = UU.IDUsuario  ) AS PERFIL ");
