        ...
        try
        {
           ...
           // Sistran.Library.GetDataTables.RetornarDataTableWS(sqlCampos, cnx).Rows[0][0].ToString();
            ...
            if (c[0].controlPointId == "MAP")
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    sql = "Update DocumentoFilial set Situacao='LIBERADO PARA SEPARACAO' Where IdDocumento=" + dt.Rows[0]["IdDocumento"].ToString();
            ...
            else if (c[0].controlPointId == "MNA")
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    sql = "Update DocumentoFilial set Situacao='REPROVADO PAGAMENTO' Where IdDocumento=" + dt.Rows[0]["IdDocumento"].ToString();
                    sql += "; UPDATE DOCUMENTO SET ATIVO='NAO' WHERE IDDOCUMENTO = " + dt.Rows[0]["IdDocumento"].ToString();
                    Sistran.Library.GetDataTables.ExecutarComandoSqlTrans(sql, cnx);
                }
            }
