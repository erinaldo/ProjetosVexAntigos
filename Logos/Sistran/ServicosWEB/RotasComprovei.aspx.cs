    ...
    public partial class RotasComprovei : System.Web.UI.Page
    {
        ...
        private void pesquisar()
        {
            ...
            if (txtData.Text != "" && txtDataAte.Text != "")
            {
                ...
                {
                    sqlEnviados += " And DataDeSaida >=getdate()-2";
                }
            }
            else
                sqlEnviados += " And DataDeSaida >=getdate()-2";
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                string sql = "Update dt set ROTAENVIADACOMPROVEI=null  where IdDt = " + e.CommandName.ToString() + "; Select 1;";
