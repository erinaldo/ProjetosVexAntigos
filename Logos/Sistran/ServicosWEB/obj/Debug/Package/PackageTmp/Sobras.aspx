<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sobras.aspx.cs" Inherits="ServicosWEB.Sobras" %>

<%@ Register Src="CtrMenu.ascx" TagName="CtrMenu" TagPrefix="uc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Relatório de Faltas Por Filial</title>
...
<body>
    ...
    <div style="margin: 0 auto; width: 100%">
        <div style="margin: 5px; width: 100%">
            <span style="font-size: 14px; font-weight: bold; color: Black; font-family: Verdana;">
                SOBRA DE ITENS</span></div>
                                ...
                                <tr>
                                    ...
                                    <td colspan="6">
                                        <asp:TextBox ID="txtChave" runat="server" BorderColor="#999999" BorderStyle="Solid"
                                            BorderWidth="1px" Width="350px" MaxLength="44">
                                        </asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <asp:DropDownList ID="cboStatus" runat="server" Width="350px" Style="border: 1px solid silver"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtDataI" runat="server" BorderColor="#999999" BorderStyle="Solid"
                                            BorderWidth="1px" Width="350px" MaxLength="10" onblur="fctValidaData(this);"
                                            TabIndex="2" onKeyUp="mascara_data(this)"></asp:TextBox>
                                    </td>
                                    <td>
                                        ATÉ:
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtDataF" runat="server" BorderColor="#999999" BorderStyle="Solid"
                                            BorderWidth="1px" Width="350px" MaxLength="10" onblur="fctValidaData(this);"
                                            TabIndex="3" onKeyUp="mascara_data(this)"></asp:TextBox>
                                    </td>
                                    <td>
                                        &nbsp;
                                    </td>
