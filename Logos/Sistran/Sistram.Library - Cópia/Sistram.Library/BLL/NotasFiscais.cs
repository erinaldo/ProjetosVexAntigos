...
namespace SistranBLL
{
    public sealed class NotasFiscais
    {
        ...
        {
            return SistranDAO.NotasFiscais.ListarDadosResumoPorFilial(Ini, Fim, clientes, Conn, tipo, series);
        }

        public static DataTable ListarResumoPorFilial(DateTime Ini, DateTime Fim, string clientes, string Conn, Sistran.Library.Enuns.tipoReportResumoFilial tipo, string series)
        {
            DataTable dttemp = SistranDAO.NotasFiscais.ListarResumoPorFilial(Ini, Fim, clientes, Conn, tipo, series);
