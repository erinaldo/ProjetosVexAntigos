...
namespace SistranDAO
{
    public sealed class NotasFiscais
    {
        ...
        public static SistranMODEL.NotasFiscais RetornaNotaFiscalSaida(int NotaFiscalId, string Conn)
        {
            ...
            strsql.Append(" WHERE   ");
            strsql.Append(" DOC.TIPODEDOCUMENTO IN('NOTA FISCAL', 'ORDEM DE SERVICO', 'GUIA DE REMESSA')  AND TIPODESERVICO IN('TRANSPORTE', 'COLETA') ");
        ...
        public static DataTable ListarDesempenhoEntregaCidade(DateTime Ini, DateTime Fim, string clientes, string ordem, string ordem2, string Conn, bool incluirTransportadora)
        {
            ...
            strsql.Append(" WHERE NF.ATIVO='SIM'  AND NF.SERIE<>'UNI'");
            strsql.Append(" AND NF.DATADEEMISSAO BETWEEN CONVERT(DATETIME, '" + Ini + "', 103)  ");
            strsql.Append(" AND CONVERT(DATETIME, '" + Fim + "', 103)   ");
            strsql.Append(" AND NF.TIPODEDOCUMENTO IN('NOTA FISCAL', 'ORDEM DE SERVICO', 'GUIA DE REMESSA')  AND TIPODESERVICO IN('TRANSPORTE', 'COLETA') ");
        ...
        public static DataTable ListarDesempenhoEntregaDia(DateTime Ini, DateTime Fim, string clientes, string Conn)
        {
            ...
            strsql.Append(" AND NF.DATADEEMISSAO BETWEEN CONVERT(DATETIME, '" + Ini + "', 103) ");
            strsql.Append(" AND CONVERT(DATETIME, '" + Fim + "', 103) ");
            strsql.Append(" AND NF.SERIE<>'UNI' ");
        ...
        public static DataTable ListarResumoPorFilial(DateTime Ini, DateTime Fim, string clientes, string Conn, Enuns.tipoReportResumoFilial tipo, string series)
        {
            StringBuilder strsql = new StringBuilder();
            ...
            strsql.Append(" WHERE   NF.SERIE <>'UNI' ");
            strsql.Append(" AND NF.TIPODEDOCUMENTO IN('NOTA FISCAL', 'ORDEM DE SERVICO', 'GUIA DE REMESSA')  AND TIPODESERVICO IN('TRANSPORTE', 'COLETA')  ");
            strsql.Append(" AND NF.ATIVO='SIM'   ");
            strsql.Append(" AND NF.DATADEEMISSAO BETWEEN  CONVERT(DATETIME, '" + Ini + "', 103) AND CONVERT(DATETIME, '" + Fim + "', 103)  ");
        ...
        public static DataTable ListarOcorrenciasPorNota(DateTime Ini, DateTime Fim, string clientes, string Conn, Enuns.tipoReportResumoFilial tipo, string series)
        {
            string strsql = " "; 
                ...
                strsql += " WHERE    "; 
                strsql += " NF.SERIE <>'UNI'   "; 
                strsql += " AND NF.TIPODEDOCUMENTO IN('NOTA FISCAL', 'ORDEM DE SERVICO', 'GUIA DE REMESSA')   ";
        ...
        public static DataTable ListarDadosResumoPorFilial(DateTime Ini, DateTime Fim, string clientes, string Conn, Enuns.tipoReportResumoFilial tipo, string series)
        {
            StringBuilder strsql = new StringBuilder();
            ...
            DataTable dtOco = ListarOcorrenciasPorNota(Ini, Fim, clientes, Conn, tipo, series);
        ...
        public static DataTable ListarResumoPorFilialPrazoNovo(DateTime Ini, DateTime Fim, string clientes, string Conn)
        {
            ...
            strsql.Append(" WHERE   DOC.SERIE <> 'UNI'");
            strsql.Append(" AND DOC.TIPODEDOCUMENTO IN('NOTA FISCAL', 'ORDEM DE SERVICO', 'GUIA DE REMESSA')  AND TIPODESERVICO IN('TRANSPORTE', 'COLETA')  ");
        ...
        public static DataTable ListarHomeAguardandoEmbarque(string clientes, string Conn, string situacao, DateTime? ini, DateTime? fim)
        {
            ...
            strsql.Append(" AND DOC.DATADECONCLUSAO IS NULL  AND  DOC.SERIE <> 'UNI'");
            strsql.Append(" AND DOC.TIPODEDOCUMENTO IN('NOTA FISCAL', 'ORDEM DE SERVICO', 'GUIA DE REMESSA')  AND TIPODESERVICO IN('TRANSPORTE', 'COLETA')  ");
