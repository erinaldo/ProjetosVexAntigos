    ...
    public class Robo
    {
        ...
        public void Gerar(string email)
        {
            try
            {
                ...
                strsql += " and RE.Emissao >=  CONVERT(datetime, '01/01/2012',103)  ";
                ...
                strsql += " and CNH.DataDeEmissao >= '01/jan/2012' "; //fixo
                ...
                strsql += " AND DOC.TIPODEDOCUMENTO IN('NOTA FISCAL', 'ORDEM DE SERVICO', 'GUIA DE REMESSA')   ";
                ...
                strsql += " AND DataDeEmissao >='2012-01-01' ";
                strsql += " GROUP BY  ";
                ...
                strsql += " where ";
                strsql += " CNH.FilialDestino = CEMB.FilialAtual  ";
                strsql += " and CNH.DataDeEmissao >= '01/jan/2012' "; // fixa
                strsql += " and CNH.DataDeEntrega is null ";
                strsql += " and DATEDIFF(day, CNH.DataDeEmissao, GETDATE()) > 5 AND CNH.SITUACAODAIMPRESSAODOCTRC<>'CANCELADO' ";
                strsql += " ) SemDataDeEntrega ";
...
throw ex;
        ...
        public void GerarBaseNova(string email)
        {
            ...
            strsqlGeral += " AND DATADEEMISSAO = '2012-01-01'";
