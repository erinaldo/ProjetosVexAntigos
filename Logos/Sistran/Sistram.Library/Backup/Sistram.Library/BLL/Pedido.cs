...
namespace SistranBLL
{
    public class Pedido
    {
        ...
        public int InserirTabDocumentoItemPedido(int IdDocumento, int IdDocumentoEmbalagem, int IdUsuario, int IdClienteDivisao, int Quantidade, decimal VlUnitario)
        {
            return new SistranDAO.Pedido().InserirTabDocumentoItemPedido(IdDocumento, IdDocumentoEmbalagem, IdUsuario, IdClienteDivisao, Quantidade, VlUnitario);
        }
