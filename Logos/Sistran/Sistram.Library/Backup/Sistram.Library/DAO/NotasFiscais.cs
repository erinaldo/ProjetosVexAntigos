...
namespace SistranDAO
{
    ...
    {
        public DataTable RetornarNFByChave(string chave)
        {
            string sql ="SELECT * FROM DOCUMENTO WHERE DOCUMENTODOCLIENTE4='"+ chave +"'";
            return Sistran.Library.GetDataTables.RetornarDataTable(sql, "");
        }
