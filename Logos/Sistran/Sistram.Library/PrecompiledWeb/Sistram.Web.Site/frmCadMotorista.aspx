<%@ page language="C#" masterpagefile="~/Site.master" autoeventwireup="true" inherits="Intranet_frmCadMotorista, App_Web_p3uplnwq" %>
        ...
        <tr>
            <td>
                ...
                <telerik:RadTabStrip ID="RadTabStrip1" runat="server" MultiPageID="rmp" Width="100%"
                    ...
                    <Tabs>
                        <telerik:RadTab runat="server" PageViewID="pgnDadosPessoais" Text="Dados Pessoais / Habilitação">
                        </telerik:RadTab>
                        <telerik:RadTab runat="server" PageViewID="pgnDadosBancarios" 
                            Text="Dados Bancários / Outros" Selected="True">
                        </telerik:RadTab>
