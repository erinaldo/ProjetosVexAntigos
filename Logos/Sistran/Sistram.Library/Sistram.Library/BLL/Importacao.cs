    ...
    public class Importacao
    {
        ...
        private void ProcessarRegistroNF(string chave)
        {
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                oPed.InserirTabDocumentoItemPedido(idDocumento, idProdutoEmbalagem, ILusuario[0].UsuarioId, Convert.ToInt32(dx.Rows[0]["IdClienteDivisao"]), Convert.ToInt32(Convert.ToDouble(QuantidadeFaturada)), Convert.ToDecimal(dx.Rows[0]["VALORUNITARIO"]), 0, "");
