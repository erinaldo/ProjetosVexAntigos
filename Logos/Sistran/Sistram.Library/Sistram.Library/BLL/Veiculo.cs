...
namespace SistranBLL
{
    public class Veiculo
    {
        ...
        {
            return new SistranDAO.Veiculo().ListarMonitoramentoInterno(data, filiais, cliente, ordem, Conn);
        }
        ...
        {
            return new SistranDAO.Veiculo().Inserir(IDVEICULOMODELO, IDVEICULOTIPO, IDVEICULORASTREADOR, IDCIDADE, IDPROPRIETARIO, IDMOTORISTA, PLACA, RENAVAN, CHASSI, ANO, COR, CAPACIDADEDECARGAKG, CAPACIDADEDECARGAM3, QUATIDADEDEEIXOS, CATEGORIASDECNHPERMITIDAS, ANTT, NUMEROSERIEEQUIPAMENTO, VencAntt, DataLicenc, MarcaDescricao, anoModelo, referenciasComPes);
        }
        ...
        {
            new SistranDAO.Veiculo().Update(IDVEICULO, IDVEICULOMODELO, IDVEICULOTIPO, IDVEICULORASTREADOR, IDCIDADE, IDPROPRIETARIO, IDMOTORISTA, PLACA, RENAVAN, CHASSI, ANO, COR, CAPACIDADEDECARGAKG, CAPACIDADEDECARGAM3, QUATIDADEDEEIXOS, CATEGORIASDECNHPERMITIDAS, ANTT, NUMEROSERIEEQUIPAMENTO, VenctoAntt, DataLiecenc, MarcaDescricao, AnoModelo, referenciasComPes);
        }
