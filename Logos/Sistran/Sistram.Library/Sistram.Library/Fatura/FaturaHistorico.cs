...
namespace Sistran.Library.Fatura
{
    public static class FaturaHistorico
    {
        public static void gravarLog(string acao, string idtitulo, string cnx)
        {
            ...
            string strsql = " INSERT INTO TITULOHISTORICO (IDTITULOHISTORICO, IDTITULO, HISTORICO, DATADECADASTRO, IDUSUARIO) VALUES (" + ID + ", " + idtitulo + ", 'WEB: " + acao.ToUpper() + "', getdate(), (select top 1 IdUsuario from Usuario where Ativo='SIM'))";
