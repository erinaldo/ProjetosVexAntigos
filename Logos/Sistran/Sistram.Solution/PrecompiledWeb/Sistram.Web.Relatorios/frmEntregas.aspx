<%@ page title="" language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="frmEntregas, App_Web_vjligygf" enabletheming="true" theme="Adm" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="Server">
    ...
    <telerik:RadTabStrip ID="RadTabStrip1" runat="server" MultiPageID="rmp" SelectedIndex="1"
        Width="100%" AutoPostBack="True" OnTabClick="RadTabStrip1_TabClick" 
        Skin="Outlook">
        <Tabs>
            <telerik:RadTab runat="server" PageViewID="rpvNotaFiscal" Text="Nota Fiscal">
            </telerik:RadTab>
            <telerik:RadTab runat="server" PageViewID="rpvItens" Text="Itens Nota Fiscal" Selected="True">
            </telerik:RadTab>
        </Tabs>
    </telerik:RadTabStrip>
    <telerik:RadMultiPage ID="rmp" runat="server" SelectedIndex="4" BackColor="White"
            ...
            <asp:Panel ID="pnlNF" runat="server" Height="500px" Width="100%" Style="text-align: left">
                <table class="table" border="0" cellpadding="0" cellspacing="0">
                    <table id="tbl" runat="server" width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tr valign="top">
                            <td>
                                <table border="1" cellspacing="1" class="table" width="100%" cellpadding="2" 
                        ...
                        <tr>
                            <td valign="top">
                                <table border="1" cellpadding="2" cellspacing="1" class="table" width="100%" 
                                    style="font-family: Verdana; font-size: 8pt">
                                    <tr>
                                        <td class="tdp" style="width: 15%">
                                            Data Movimento:
                        ...
                        <tr>
                            <td>
                                <table id="d" border="1" cellpadding="1" cellspacing="1" class="table">
                                    <tr bgcolor="#AEFFE4">
        ...
        <telerik:RadPageView ID="rpvListaEmp" runat="server" Width="100%" Style="text-align: left">
            <asp:Panel ID="pnlItensNF" runat="server" Width="100%" Style="text-align: left" BorderColor="Silver"
                ...
                <table align="left" cellspacing="2" style="width: 100%; border-style: solid; border-width: 1px; font-family: Verdana; font-size: 8pt;"
                    cellpadding="1" class="table">
                    <tr>
