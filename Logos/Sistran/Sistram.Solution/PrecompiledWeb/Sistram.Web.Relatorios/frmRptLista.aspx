<%@ page language="C#" masterpagefile="~/SiteDetalheFull.master" autoeventwireup="true" inherits="frmRptLista, App_Web_vjligygf" title="NOTAS FISCAIS AGUADANDO EMBARQUE" %>

<%@ Register assembly="Microsoft.ReportViewer.WebForms, Version=9.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a" namespace="Microsoft.Reporting.WebForms" tagprefix="rsweb" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" Runat="Server">
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" BackColor="White" 
        Font-Names="Verdana" Font-Size="8pt" Height="95%" Width="1000px">
