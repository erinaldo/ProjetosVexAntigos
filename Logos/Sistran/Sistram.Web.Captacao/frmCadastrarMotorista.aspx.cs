    ...
    public partial class frmCadastrarMotorista : System.Web.UI.Page
    {
        ...
        private void salvar()
        {
            ...
            {               
                ...
                {
                    oMot.VencimentoPamcary = DateTime.Now;
                ...
                {
                    oMot.VencimentoBuonny = DateTime.Now;
                ...
                {
                    oMot.VencimentoBrasilrisk = DateTime.Now;
                ...
                string strsql = "select idcadastro from cadastro where cnpjcpf='"+ txtcpfcnpj.Text +"' ";
                DataTable codi= Sistran.Library.GetDataTables.RetornarDataTable(strsql, HttpContext.Current.Session["ConnLogin"].ToString());

                if (codi != null && codi.Rows.Count > 0)
                    lblId.Text = codi.Rows[0][0].ToString();
                ...
                if (lblId.Text == "" || lblId.Text == "0")
                {
                    ...
                    try
                    {
                        Session["cpf"] = txtcpfcnpj.Text;
                        Session["nome"] = txtRazao.Text;
