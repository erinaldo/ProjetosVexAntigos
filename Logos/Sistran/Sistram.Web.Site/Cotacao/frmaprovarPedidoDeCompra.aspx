<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmaprovarPedidoDeCompra.aspx.cs"
    Inherits="frmaprovarPedidoDeCompra" MasterPageFile="SiteDetalhe2.master" EnableTheming="true" %>
                ...
                <table class="grid">
                    <tr>
                        <td style="text-align: center; font-family: Arial, Helvetica, sans-serif; font-size: medium;">
                            <strong>PEDIDO(S) PENDENTE(S) DE APROVAÇÃO(ÇÕES)</strong></td>
                    </tr>
                    <tr>
                        <td>
                           <hr /></td>
