...
public partial class FrmConsultarMaterial : System.Web.UI.Page
{
    ...
    private void carregarGrid()
    {
        ...
        DataTable dt = new SistranBLL.Produto().ListarProdutosFiltroConsultarMaterial(txtCodigo.Text, txtCodigo0.Text, true, false, Sistran.Library.FuncoesUteis.retornarClientes());
