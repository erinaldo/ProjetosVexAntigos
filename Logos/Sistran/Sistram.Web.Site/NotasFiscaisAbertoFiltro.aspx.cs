    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                btnGerarReport.Attributes.Add("onClick", "window.open('frmRptEntregas.aspx?tipo=TELA&tit=" + titulo+ "', 'NovaJanela2', 'yes')");
                btnPDF.Attributes.Add("onClick", "window.open('frmRptEntregas.aspx?tipo=PDF&tit=" + titulo + "', 'NovaJanela22', 'yes')");
...
//        ssql.Append(" AND DOC.TIPODEDOCUMENTO = 'NOTA FISCAL' ");
        ...
        ssql.Append(" AND NOT DOC.CODIGODORECEXP IS NULL  AND DOC.SERIE<>'UNI' AND SERIE<>'DEV' ");
