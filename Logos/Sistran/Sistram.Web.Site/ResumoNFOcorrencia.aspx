<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ResumoNFOcorrencia.aspx.cs"
    Inherits="ResumoNFOcorrencia" Theme="Adm" EnableTheming="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="Server">
    <asp:Panel ID="pnlteste" runat="server">
        ...
        <table id="novatb" runat="server" cellpadding="1" cellspacing="0" class="table" width="100%">
            <tr valign="baseline">
                <td style="font-size: 8pt" width="1%">
                    Período:</td>
                                ...
                                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <asp:RadioButtonList ID="RadioButtonList1" runat="server" 
                                            ...
                                            <asp:ListItem Enabled="False">Data Emissão</asp:ListItem>
                                            <asp:ListItem>Data Da Ocorrência</asp:ListItem>
                                        </asp:RadioButtonList>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </td>
