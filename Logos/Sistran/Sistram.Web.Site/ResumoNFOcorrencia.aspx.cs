...
public partial class ResumoNFOcorrencia : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                btnGerarReport.Attributes.Add("onClick", "window.open('frmRptResumoOcorrencia.aspx?n=" + Guid.NewGuid() + "&tipo=TELA&tit=" + Server.UrlEncode(Request.QueryString["opc"].ToString()) + "', 'NovaJanela2', 'yes')");
                btnPDF.Attributes.Add("onClick", "window.open('frmRptResumoOcorrencia.aspx?tipo=PDF&tit=" + Server.UrlEncode(Request.QueryString["opc"].ToString()) + "', 'NovaJanela22', 'yes')");
    ...
    private void MontarTableComOcorrenciasResponsabilidades()
    {
        ...
        if (dtResp.Rows.Count > 0)
        {
            ...
            phResponsabulidadeCliente.Controls.Add(new LiteralControl(@"<td class='tdpCabecalho' align='left' nowrap=nowrap style='font-size:7.5pt;Width=1%'>Finalizadora"));
            phResponsabulidadeCliente.Controls.Add(new LiteralControl(@"</td>"));
            ...
            phResponsabulidadeTransporte.Controls.Add(new LiteralControl(@"<td class='tdpCabecalho' align='left' nowrap=nowrap style='font-size:7.5pt;Width=1%'>Finalizadora"));
            phResponsabulidadeTransporte.Controls.Add(new LiteralControl(@"</td>"));
            ...
            foreach (DataRow item in dtResp.Rows)
            {
                if (item["RESPONSABILIDADE"].ToString().ToUpper() == "CLIENTE")
                {
                    ...
                    phResponsabulidadeCliente.Controls.Add(new LiteralControl(@"<td class='tdp' nowrap=nowrap  style='font-size:7.5pt;height:10px'>" + item["FINALIZADOR"]));
                    phResponsabulidadeCliente.Controls.Add(new LiteralControl(@"</td>"));
                ...
                else
                {
                    ...
                    phResponsabulidadeTransporte.Controls.Add(new LiteralControl(@"<td class='tdp' nowrap=nowrap  style='font-size:7.5pt;height:10px'>" + item["FINALIZADOR"]));
                    phResponsabulidadeTransporte.Controls.Add(new LiteralControl(@"</td>"));
            ...
            phResponsabulidadeCliente.Controls.Add(new LiteralControl(@"<td class='tdpCabecalho' align='right' nowrap=nowrap style='font-size:7.5pt;'>"));
            phResponsabulidadeCliente.Controls.Add(new LiteralControl(@"</td>"));
            ...
            phResponsabulidadeTransporte.Controls.Add(new LiteralControl(@"<td class='tdpCabecalho' align='right' nowrap=nowrap style='font-size:7.5pt;'>"));
            phResponsabulidadeTransporte.Controls.Add(new LiteralControl(@"</td>"));
        ...
        if (dtResp.Rows.Count > 0)
        {
            ...
            pnlGrafRespTransporte.Controls.Add(cGraficos.GraficoGeralResponsabilidade(dtResp, "TRANSPORTADOR"));
    ...
    private void Carregar()
    {
        ...
        if (dtRespFiliais.Rows.Count > 0)
        {
            ...
            pnlGrafRespFilialTransporte.Controls.Add(cGraficos.MontarGraficoFilialResponsavel(dtRespFiliais, "TRANSPORTADOR"));
    ...
    protected void MontarTableComOcorrenciasGeral()
    {
        ...
        if (dtOcoGeral.Rows.Count > 0)
        {
            ...
            PlaceHolder3.Controls.Add(new LiteralControl(@"<td class='tdpCabecalho' align='left' nowrap=nowrap style='font-size:8pt;'> &nbsp;FINALIZADORA"));
            PlaceHolder3.Controls.Add(new LiteralControl(@"</td>"));
            ...
            {
                PlaceHolder3.Controls.Add(new LiteralControl(@"<tr>"));
                PlaceHolder3.Controls.Add(new LiteralControl(@"<td class='tdpVerdana' nowrap=nowrap  style='font-size:8pt;height:10px' align='left'><a href='NotasFiscaisOcorrenciaFiltro.aspx?tipod="+(RadioButtonList1.SelectedIndex==0?"emissao":"ocorrencia") +"&idOcorrencia=" + Server.UrlEncode(item["Codigo"].ToString().Trim()) + "' class='link'>" + item["Codigo"].ToString() + "-" + item["Nome"].ToString() + "</a>"));
                PlaceHolder3.Controls.Add(new LiteralControl(@"</td>"));

                PlaceHolder3.Controls.Add(new LiteralControl(@"<td class='tdp' nowrap=nowrap  style='font-size:8pt;height:10px'>" + item["FINALIZADOR"].ToString() ));
                PlaceHolder3.Controls.Add(new LiteralControl(@"</td>"));
            ...
            PlaceHolder3.Controls.Add(new LiteralControl(@"<td class='tdpCabecalho' align='right' nowrap=nowrap style='font-size:8pt;'>"));
            PlaceHolder3.Controls.Add(new LiteralControl(@"</td>"));
    ...
    protected void btnGerarReport_Click(object sender, EventArgs e)
    {
        ...
        if (dts.Rows.Count > 0)
        {
            ...
            pnlGrafRespFilialTransporte.Controls.Add(cGraficos.MontarGraficoFilialResponsavel(dts, "TRANSPORTADOR"));
        }
    }
