...
public partial class ResumoNFOcorrenciaPorDatas : System.Web.UI.Page
{
    ...
    {
        DataTable dtOcoFilial = NotasFiscais.ListarHomeNotasFiscaisComOcorrenciasFilial(Sistran.Library.FuncoesUteis.retornarClientes(), Session["Conn"].ToString(), Convert.ToDateTime(txtI.Text), Convert.ToDateTime(txtF.Text), false, true);
    ...
    {
        DataTable dtResp = NotasFiscais.ListarHomeNotasFiscaisComOcorrenciasResponsabilidade(Sistran.Library.FuncoesUteis.retornarClientes(), Session["Conn"].ToString(), Convert.ToDateTime(txtI.Text), Convert.ToDateTime(txtF.Text), false, true);
    ...
    protected void MontarTableComOcorrenciasGeral()
    {
        ...
        DataTable dtOcoGeral = NotasFiscais.ListarHomeNotasFiscaisComOcorrencias(Sistran.Library.FuncoesUteis.retornarClientes(), Session["Conn"].ToString(), Convert.ToDateTime(txtI.Text), Convert.ToDateTime(txtF.Text), false, true);
    ...
    private void Carregar()
    {
        ...
        DataTable dtRespFiliais = SistranBLL.NotasFiscais.ListarHomeNotasFiscaisComOcorrenciasFilialResponsaveis(Sistran.Library.FuncoesUteis.retornarClientes(), "", Convert.ToDateTime(txtI.Text), Convert.ToDateTime(txtF.Text), false, true);
    ...
    protected void btnGerarReport_Click(object sender, EventArgs e)
    {
        ...
        MontarTableComOcorrenciasResponsabilidades();
        MontarTableOcorrenciaPorFlilial();
        DataTable dts = SistranBLL.NotasFiscais.ListarHomeNotasFiscaisComOcorrenciasFilialResponsaveis(Sistran.Library.FuncoesUteis.retornarClientes(), "", Convert.ToDateTime(txtI.Text), Convert.ToDateTime(txtF.Text), false, true);
        if (dts.Rows.Count > 0)
        {
