<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frmCadProprietario.aspx.cs"
    Inherits="Intranet_frmCadProprietario" %>
        ...
        <tr>
            ...
            <td class="tdpR" nowrap="nowrap">
                ...
                &nbsp;<asp:Button ID="btnCancelar" runat="server" CausesValidation="False" CssClass="button"
                    OnClientClick="javascript:history.back(-1);" Text="VOLTAR" Width="100px" />
