...
public partial class frmKPIRecebimento : System.Web.UI.Page
{
    ...
    protected void MontarTable()
    {
        ...
        strsql += " AND DOC.ENTRADASAIDA='ENTRADA' ";
        strsql += " AND DOC.ATIVO='SIM' ";
        strsql += " AND IDCLIENTE= " + ILusuario[0].EmpresaId;
    ...
    private void gerarGrafico(DataTable dt)
    {
        ...
        cr.Titles.Add("RECEBIMENTO - NOTAS FISCAIS");
        ...
        cr.Series[2].Points.DataBindXY(dias, SkuPorNota);
