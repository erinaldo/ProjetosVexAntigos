...
public partial class frmLocalizacaoProduto : System.Web.UI.Page
{
    ...
    protected void MontarTable()
    {
		...
		PlaceHolder1.Controls.Add(new LiteralControl(@"<td class='tdpCabecalho' style='font-size:7pt;' nowrap=nowrap align='center'>VALIDADE"));
		PlaceHolder1.Controls.Add(new LiteralControl(@"</td>"));

		PlaceHolder1.Controls.Add(new LiteralControl(@"<td class='tdpCabecalho' style='font-size:7pt;' nowrap=nowrap align='center'>LOTE"));
		PlaceHolder1.Controls.Add(new LiteralControl(@"</td>"));
        ...
        for (int i = 0; i < dt.Rows.Count; i++)
        {
			...
			PlaceHolder1.Controls.Add(new LiteralControl(@"<td class='tdpCenter' nowrap=nowrap style='font-size:7pt;height:10px'>" + dt.Rows[i]["Validade"].ToString() + "</td>"));
			PlaceHolder1.Controls.Add(new LiteralControl(@"<td class='tdp' nowrap=nowrap style='font-size:7pt;height:10px'>" + dt.Rows[i]["IdLote"].ToString() + "</td>"));
			PlaceHolder1.Controls.Add(new LiteralControl(@"</tr>"));
        }
