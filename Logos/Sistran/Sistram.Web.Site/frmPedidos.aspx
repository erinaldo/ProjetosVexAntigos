<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frmPedidos.aspx.cs"
    Inherits="frmPedidos" Title="Bem Vindo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="Server">
    ...
    <div style="position: absolute; top: 5%; left: 95%">
        <asp:Panel ID="pnlCar" runat="server" Font-Names="Arial" Font-Size="8px" ForeColor="Black"
            Height="100%" HorizontalAlign="Right" Style="text-align: center">
            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                ...
                <tr>
                    <td style="text-align: center">
                        <asp:ImageButton ID="imgCar" runat="server" Height="40px" ImageUrl="~/images/VerCarrinho.jpg"
                            PostBackUrl="frmCarrinho.aspx" Style="text-align: center" ToolTip="Ver Carrinho" />
                    </td>
                </tr>
                <tr>
                    <td style="text-align: center">
                        <asp:Label ID="lblcar" runat="server" Style="font-weight: 700; color: #FF0000; font-size: 9px"
                            Text="Nenhum Item."></asp:Label>
                    </td>
                </tr>
            </table>
        </asp:Panel>
                        ...
                        <tr align="center">
                            <td align="center" style="width: 100%">
                                <asp:LinkButton ID="LinkButton1" runat="server" BorderColor="#999999" BorderStyle="None"
                                    BorderWidth="1px" Font-Names="Verdana" Font-Size="7pt" Font-Underline="False"
    ...
    <table  runat="server" width="100%" border="0">
        <tr id="Tr1" runat="server" valign="top">
            <td style="width: 15%" class="pnlMenus">
                <asp:UpdatePanel ID="uplBot" runat="server">
                    <ContentTemplate>
                        <asp:Panel ID="pnlMenu" runat="server" ScrollBars="Auto">
                            <asp:PlaceHolder ID="PlaceHolderMenuDivisao" runat="server"></asp:PlaceHolder>
                            <br />
                            <asp:PlaceHolder ID="PlaceHolderMenuGrupo" runat="server"></asp:PlaceHolder>
                            <br />
                        </asp:Panel>
                    </ContentTemplate>
                </asp:UpdatePanel>
            ...
            <td style="width: 85%; text-align: center;">
                <asp:DataList ID="DataList1" runat="server" BorderColor="Silver" BorderWidth="1px"
                    ...
                    <ItemTemplate>
                        <table style="font-family: Verdana; font-size: 8pt; width: 100%" border="0" cellpadding="2"
                            cellspacing="2">
                            <tr>
                                <td>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <asp:Panel ID="pnlAjax" runat="server" BackColor="White" HorizontalAlign="Center">
