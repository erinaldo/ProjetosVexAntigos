...
namespace SistecnoColetor.Classes.BLL
{
    ...
    {
        public DataTable retornarConferenciaByChave(string chave, string id)
        {
            return new DAL.Documento().retornarConferenciaByChave(chave, id);
        }
    }
    ...
    public class DepositoPlantaLocalizacao
    {
        ...
        public string[] RetornarEndereco(string IdProdutoCliente, string Metodo, string enderecoPicking)
        {
            ...
            ret[0] = d.Rows[0]["IdDepositoplantalocalizacao"].ToString();
            ret[1] = d.Rows[0]["Codigo"].ToString();
            ret[2] = d.Rows[0]["idUnidadeDeArmazenagem"].ToString();
            ...
            //    x[0] = o[0]["IDDEPOSITOPLANTALOCALIZACAO"].ToString();
            //    x[1] = o[0]["CODIGO"].ToString();
            //    x[2] = o[0]["IDUNIDADEDEARMAZENAGEM"].ToString();
            //   // ///x[1] = o[0]["CODIGO"].ToString();
            //   //// x[2] = ;
            //    dttem.Rows.Add(x);
            ...
            //else
            //{
            //    ret[0] = Z.Rows[contZ-1]["IDDepositoPlantaLocalizacao"].ToString();
            //    ret[1] = Z.Rows[contZ-1]["Descricao"].ToString();
            //    ret[2] = A.Rows[contZ-1]["IdUnidadeDeArmazenagem"].ToString();
            //}
            return ret;
    ...
    public class Movimentacao
    {
        ...
        public void GravarMovimentacao(
                                        ...
                                        string EntradaSaida, string IdProdutoCliente, string Origem)
        {
             new DAL.Movimentacao().GravarMovimentacao(IdUa, IdDepositoPlantaLocalizacaoOrigem, IdProdutoEmbalagem, Quantidade, Fator, IdOperacaoColetor, "ENTRADA", IdProdutoCliente, Origem);
        }
        ...
        public void GravarMovimentacao(
                                       ...
                                       string Fator,
                                       string IdOperacaoColetor,
                                       string EntradaSaida, string IdProdutoCliente, string GravarUa, string Origem)
        {
            new DAL.Movimentacao().GravarMovimentacao(IdUa, IdDepositoPlantaLocalizacaoOrigem, IdProdutoEmbalagem, Quantidade, Fator, IdOperacaoColetor, "ENTRADA", IdProdutoCliente,  GravarUa, Origem);
        }
    }
}