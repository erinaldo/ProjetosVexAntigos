...
namespace EnvioDeRota.br.com.comprovei.ws_teste {
    ...
    public partial class WebServiceComprovei : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback sendDocsToPODV2OperationCompleted;
        ...
        private System.Threading.SendOrPostCallback sendNfeOperationCompleted;
        ...
        public WebServiceComprovei() {
            this.Url = global::EnvioDeRota.Properties.Settings.Default.EnvioDeRota_br_com_comprovei_ws_teste_WebServiceComprovei;
        ...
        /// <remarks/>
        public event sendDocsToPODV2CompletedEventHandler sendDocsToPODV2Completed;
        ...
        /// <remarks/>
        public event sendNfeCompletedEventHandler sendNfeCompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapRpcMethodAttribute("urn:WebServiceComprovei#uploadRouteUsingDocumentKey", RequestNamespace="urn:WebServiceComprovei", ResponseNamespace="urn:WebServiceComprovei")]
        [return: System.Xml.Serialization.SoapElementAttribute("status")]
        public string uploadRouteUsingDocumentKey(string conteudoArquivo, string nomeArquivo, out string protocolo) {
        ...
        /// <remarks/>
        public void uploadRouteUsingDocumentKeyAsync(string conteudoArquivo, string nomeArquivo) {
            this.uploadRouteUsingDocumentKeyAsync(conteudoArquivo, nomeArquivo, null);
        }
        
        /// <remarks/>
        public void uploadRouteUsingDocumentKeyAsync(string conteudoArquivo, string nomeArquivo, object userState) {
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapRpcMethodAttribute("urn:WebServiceComprovei#sendDocsToPODV2", RequestNamespace="urn:WebServiceComprovei", ResponseNamespace="urn:WebServiceComprovei")]
        [return: System.Xml.Serialization.SoapElementAttribute("status")]
        public string sendDocsToPODV2(string conteudoArquivo, string nomeArquivo) {
            object[] results = this.Invoke("sendDocsToPODV2", new object[] {
                        conteudoArquivo,
                        nomeArquivo});
            return ((string)(results[0]));
        }
        ...
        /// <remarks/>
        public void sendDocsToPODV2Async(string conteudoArquivo, string nomeArquivo) {
            this.sendDocsToPODV2Async(conteudoArquivo, nomeArquivo, null);
        }
        
        /// <remarks/>
        public void sendDocsToPODV2Async(string conteudoArquivo, string nomeArquivo, object userState) {
            if ((this.sendDocsToPODV2OperationCompleted == null)) {
                this.sendDocsToPODV2OperationCompleted = new System.Threading.SendOrPostCallback(this.OnsendDocsToPODV2OperationCompleted);
            }
            this.InvokeAsync("sendDocsToPODV2", new object[] {
                        conteudoArquivo,
                        nomeArquivo}, this.sendDocsToPODV2OperationCompleted, userState);
        }
        
        private void OnsendDocsToPODV2OperationCompleted(object arg) {
            if ((this.sendDocsToPODV2Completed != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.sendDocsToPODV2Completed(this, new sendDocsToPODV2CompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapRpcMethodAttribute("urn:WebServiceComprovei#sendNfe", RequestNamespace="urn:WebServiceComprovei", ResponseNamespace="urn:WebServiceComprovei")]
        [return: System.Xml.Serialization.SoapElementAttribute("codigoRetorno", DataType="integer")]
        public string sendNfe(string conteudoArquivo, out string mensagemRetorno) {
            object[] results = this.Invoke("sendNfe", new object[] {
                        conteudoArquivo});
            mensagemRetorno = ((string)(results[1]));
            return ((string)(results[0]));
        }
        
        /// <remarks/>
        public void sendNfeAsync(string conteudoArquivo) {
            this.sendNfeAsync(conteudoArquivo, null);
        }
        
        /// <remarks/>
        public void sendNfeAsync(string conteudoArquivo, object userState) {
            if ((this.sendNfeOperationCompleted == null)) {
                this.sendNfeOperationCompleted = new System.Threading.SendOrPostCallback(this.OnsendNfeOperationCompleted);
            }
            this.InvokeAsync("sendNfe", new object[] {
                        conteudoArquivo}, this.sendNfeOperationCompleted, userState);
        }
        
        private void OnsendNfeOperationCompleted(object arg) {
            if ((this.sendNfeCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.sendNfeCompleted(this, new sendNfeCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.4084.0")]
    public delegate void sendDocsToPODV2CompletedEventHandler(object sender, sendDocsToPODV2CompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.4084.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class sendDocsToPODV2CompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal sendDocsToPODV2CompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.4084.0")]
    public delegate void sendNfeCompletedEventHandler(object sender, sendNfeCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.4084.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class sendNfeCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal sendNfeCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
