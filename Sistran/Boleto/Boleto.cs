...
namespace Boleto
{
	...
	public class HTMLBoleto
	{
        ...
        private string _ImagesFolder = @"imagesBoleto";
		/// <summary>
		...
		public void AddBoleto( Boleto lBoleto)
		{
            ...
            string caminhoUrl = "http://" + System.Web.HttpContext.Current.Request.ServerVariables["SERVER_NAME"];
           ...
           // string sImgBarra = _ImagesFolder + @"\barra.gif";
            ...
            _Buffer.Append("<tr><td width=150><img src='imagesBoleto/"+ lBoleto.BancoLogoTipo + "'></td>");


            _Buffer.Append("<td vAlign=bottom width=2><IMG src='imagesBoleto/" + sImgBarra + "' height=22 width=2 border=0 ></td>");
			_Buffer.Append("<td vAlign=bottom align=center width=75><span id=nb1 class=\"nbanco\">" + lBoleto.BancoCodigoCompleto() + "</span></td>");
            _Buffer.Append("<td vAlign=bottom width=2><IMG height=22 src='imagesBoleto/" + sImgBarra + "' width=2 border=0 ></td>");
            ...
            _Buffer.Append("<div align=center><img src='imagesBoleto/" + sImgCorte + "'></div>");
            */
			//Recibo do Sacado
			_Buffer.Append("<table cellSpacing=0 cellPadding=0 width=\"100%\" border=0>");
            ...
            _Buffer.Append("<td vAlign=bottom width=1><IMG height=22 src='imagesBoleto/" + sImgBarra + "' width=2 border=0 ></td>");
            ...
            _Buffer.Replace("imagesBoleto/", caminhoUrl);
		...
		private string CodigoBarras25I( string Valor)
		{
            ...
            Codbarras.Append("<img src='imagesBoleto/p.gif' width=\"" + fino.ToString() + "\" height=\"" + altura.ToString() + "\" border=0>");
            Codbarras.Append("<img src='imagesBoleto/b.gif' width=\"" + fino.ToString() + "\" height=\"" + altura.ToString() + "\" border=0>");
            Codbarras.Append("<img src='imagesBoleto/p.gif' width=\"" + fino.ToString() + "\" height=\"" + altura.ToString() + "\" border=0>");
			Codbarras.Append("<img src='imagesBoleto/b.gif' width=\"" + fino.ToString() + "\" height=\"" + altura.ToString() + "\" border=0>");
			...
			while( texto.Length>0)
			{
				...
				for( i=0; i<=9; i+=2)
				{
                    ...
                    Codbarras.Append("<img src='imagesBoleto/p.gif' width=\"" + f1.ToString() + "\" height=\"" + altura.ToString() + "\" border=0>");

					if( s[ i+1]=='0') f2 = fino;
					else f2 = largo;

                    Codbarras.Append("<img src='imagesBoleto/b.gif' width=\"" + f2.ToString() + "\" height=\"" + altura.ToString() + "\" border=0>");
				}
			}

			// draw da guarda final
            Codbarras.Append("<img src='imagesBoleto/p.gif' width=\"" + largo.ToString() + "\" height=\"" + altura.ToString() + "\" border=0>");
            Codbarras.Append("<img src='imagesBoleto/b.gif' width=\"" + fino.ToString() + "\" height=\"" + altura.ToString() + "\" border=0>");
            Codbarras.Append("<img src='imagesBoleto/p.gif' width=\"" + fino.ToString() + "\" height=\"" + altura.ToString() + "\" border=0>");
