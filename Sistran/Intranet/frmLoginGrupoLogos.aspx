<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmLoginGrupoLogos.aspx.cs" Inherits="frmLoginGrupoLogos" %>
...
<body bgcolor="White">
    ...
    <div style="border: thin solid #CCCCCC; position: absolute; top: 30%; left: 36%; font-family:Verdana; font-size:10px; width:400px">
        <table cellpadding="2" cellspacing="5" runat="server" id="tbl" visible="True" 
            width="99%" bgcolor="White" border="0">
            <tr>
                        ...
                        <tr>
                            <td width="1%">
                                <asp:Image ID="Image1" runat="server" Height="40px" 
                                    ImageUrl="Imagens/LOGOS-LOGTRANSP-03.jpg" />
                            </td>
            ...
            <tr>
                ...
                <td width="99%" style="text-align: right">
                    <asp:Button ID="btnLogar" runat="server" Text="Entrar" OnClick="btnLogar_Click" 
                        ...
                        Font-Bold="True" Font-Names="Verdana" CssClass="button" Height="25px" />
                </td>
            </tr>
            <tr align="left">
                <td style="text-align: center" colspan="2" align="right">
                    <asp:Image ID="Image2" runat="server" ImageUrl="~/Images/logo.png"  style="cursor:hand"
                        ToolTip="Clique para visitar nosso site" 
                        OnClick="window.open('http://www.sistecno.com.br')" Height="20px" />
                </td>
            </tr>
        </table>
