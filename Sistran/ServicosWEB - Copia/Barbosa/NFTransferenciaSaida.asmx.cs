...
namespace ServicosWEB.Barbosa
{
    ...
    public class NFTransferenciaSaida : System.Web.Services.WebService
    {

        [WebMethod]
        public Retorno Cadastrar(Autentica Credenciais, NFsTransferenciaSaida NFsTransferenciaSaida)
        {
            try
            {
    ...
    public class NFsTransferenciaSaida
    {
