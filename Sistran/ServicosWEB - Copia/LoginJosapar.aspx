<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoginJosapar.aspx.cs" Inherits="ServicosWEB.LoginJosapar" %>
            ...
            <tr>
                <td style="text-align: left" width="1%" colspan="2">
                    <table class="style1">
                        <tr>
                            <td>
                     <img src="Img/vex.png" alt="Sistecno" width="120" />
                            </td>
                            <td style="text-align: right">
                    <asp:Image ID="Image2" runat="server" ImageUrl="~/Img/josapar.gif" Width="120px" />
                            </td>
                        </tr>
                    </table>
                </td>
