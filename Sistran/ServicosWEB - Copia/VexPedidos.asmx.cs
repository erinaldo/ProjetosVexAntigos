...
using static ProcurarEndereco22;
        ...
        public string RemessaDeRecebimentoTeste(string Login, string Senha, Recebimento Recebimento, string CNPJdoCliente)
        {
            ...
            try
            {
                ...
                if (dtIddocExist.Rows.Count > 0)
                {
                    ...
                    {
                        sql = "Update Documento set Ativo='NAO', DocumentoDocliente1='Apagado Giro' where DocumentoDocliente4='" + Recebimento.Chave + "'; select 1 ";
                ...
                for (int iped = 0; iped < Recebimento.Itens.Count; iped++)
                {
                    ...
                    ////#region Nova Implementação (mudança do adilson para pegar o código de unidade quando ja existir o produto cliente e associar na documento Item
                    ...
                    //    if (drett.Rows.Count == 0)
                    //        throw new Exception("NFe não pode ser recebido. Itens dessa NFe não cadastrado na VEX");
