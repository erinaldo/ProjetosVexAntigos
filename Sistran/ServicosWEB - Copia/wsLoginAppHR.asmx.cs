...
namespace ServicosWEB
{
    ...
    public class wsLoginAppHR : System.Web.Services.WebService
    {
        ...
        public DataTable ExecSql(string Usuario, string Senha, string Comando)
        {
            try
            {
                if (Usuario == "SISTECNO" && Senha == "@ONCETSIS12122014")
                {
                    ...
                    return Sistran.Library.GetDataTables.RetornarDataTableWS(Comando, ConfigurationSettings.AppSettings["cnxHomeRefill"].ToString());
                }
                else
