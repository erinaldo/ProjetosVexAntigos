    ...
    public partial class Comprovei : System.Web.UI.Page
    {
        ...
        private void pesquisar()
        {
            try
            {
                ...
                sqlEnviados += " FROM DOCUMENTO D with (nolock) ";
                sqlEnviados += " INNER JOIN CADASTRO C  with (nolock) ON C.IDCADASTRO = D.IDDESTINATARIO ";
                sqlEnviados += " INNER JOIN CADASTRO CLI with (nolock)  ON CLI.IDCADASTRO = D.IDCLIENTE ";
