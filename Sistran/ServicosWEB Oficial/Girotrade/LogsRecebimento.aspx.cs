...
{
    public partial class LogsRecebimento : System.Web.UI.Page
    {
        ...
        private void CarregarGrid()
        {
            ...
            try
            {
                string sql = "select a.*, d.Numero, d.DocumentodoCliente4 Chave , b.Andamento from YandehLogRetornoRecebimento a Inner join romaneio b on a.idRomaneio = b.IDRomaneio Inner join Documento d on d.IDDocumento = a.Iddocumento where d.DocumentodoCliente4 like  '%" + TextBox1.Text+"%'";
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandArgument.ToString().Contains("reenviar"))
            {
                ...
                string sql = "Update Romaneio set  Andamento ='INTERFACE LIBERADA' WHERE IDROMANEIO=" + e.CommandName;
