<%@ Page validateRequest="false" Title="" Language="C#" MasterPageFile="~/Girotrade/Site1.Master" AutoEventWireup="true" CodeBehind="LogsRecebimentoNfEntrada.aspx.cs" Inherits="ServicosWEB.Girotrade.LogsRecebimentoNfEntrada"   %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="width:200px">
        <tr>
            <td class="auto-style1" colspan="5"><strong>Notas Fiscais de Entrada Enivadas para Vex</strong></td>
    ...
    <asp:GridView ID="GridView1" runat="server" HeaderStyle-HorizontalAlign="Left" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal" OnRowCommand="GridView1_RowCommand" AutoGenerateColumns="False" Font-Names="Verdana" Font-Size="10px"  >
      ...
      <%--    <asp:TemplateField HeaderText="XML Enviado">
                <ItemTemplate>
                    <asp:TextBox ID="TextBox25" Enabled="false" runat="server" BorderStyle="None" Text='<%# Eval("DadoRecebido") %>' Width="300" TextMode="MultiLine" Height="60px"></asp:TextBox>
                </ItemTemplate>
            </asp:TemplateField>--%>
             ...
             <asp:TemplateField HeaderText="Retorno da Yandeh">
                <ItemTemplate>
                    <asp:TextBox ID="TextBox26"  Enabled="false" runat="server" BorderStyle="None" Text='<%# Eval("Acao") %>' Width="300" TextMode="MultiLine" Height="60px"></asp:TextBox>
                </ItemTemplate>
            </asp:TemplateField>
