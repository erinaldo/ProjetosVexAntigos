    ...
    public partial class Pedidos : System.Web.UI.Page
    {
        ...
        private void CarregarGrid()
        {
            try
            {
                ...
                {
                    sql += " and DataDeEntrada >= GETDATE() - 60 ";
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                string sql = "Update YandehStatusPedido set Consumido=null,DataHora = getdate() where NrPedido='" + e.CommandName.ToString() + "' and Status='LIBERADO PARA FATURAMENTO'; SELECT 1 ";
                cnx = Sistran.Library.Robo.Robo.RetornarStringBaseNovaLogos();
                DataTable dt = Sistran.Library.GetDataTables.RetornarDataTableWin(sql, cnx);
            }
        }
