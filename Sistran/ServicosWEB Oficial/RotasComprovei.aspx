                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    ...
                                    &nbsp;<asp:Button ID="btnPausar" runat="server" BackColor="White" BorderColor="Red" 
                                     ...
                                     &nbsp;<asp:Button ID="Button3" runat="server" BackColor="White" BorderColor="Red" 
                                        BorderStyle="Solid" BorderWidth="1px" CommandArgument="pendentes" 
                                        CommandName='<% # Eval("ROMANEIO") %>' Text="NFs Pendentes" />
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
