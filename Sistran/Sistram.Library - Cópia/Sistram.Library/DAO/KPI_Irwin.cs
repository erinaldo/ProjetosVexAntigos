    ...
    public sealed class KPI_Irwin
    {
        ...
        public void ExecutarScripts()
        {
            try
            {
                ...
                item.email = "wagner.batista@newellco.com";
                email.Add(item);


                item = new listaEmailIrwin();
                item.email = "moises@sistecno.com.br";
                email.Add(item);

                item = new listaEmailIrwin();
                item.email = "rodolfo.carriel@newellco.com";
                email.Add(item);

                //item = new listaEmailIrwin();
                //item.email = "alfredo.oliveira@newellco.com";
                //email.Add(item);
                ...
                //item = new listaEmailIrwin();
                //item.email = "danilo.castro@newellco.com";
                //email.Add(item);

                //item = new listaEmailIrwin();
                //item.email = "moniely.castro@newellco.com";
                //email.Add(item);

                //item = new listaEmailIrwin();
                //item.email = "gisele.lauxmann@newellco.com";
                //email.Add(item);

                //item = new listaEmailIrwin();
                //item.email = "marina.santos@newellco.com";
                //email.Add(item);

                //item = new listaEmailIrwin();
                //item.email = "roberta.daniel@newellco.com";
                //email.Add(item);

                //item = new listaEmailIrwin();
                //item.email = "marcio.jesus@newellco.com";
                //email.Add(item);

                //item = new listaEmailIrwin();
                //item.email = "roberto.barbosa@newellco.com";
                //email.Add(item);

                //item = new listaEmailIrwin();
                //item.email = "fabio.depaula@newellco.com";
                //email.Add(item);

                //item = new listaEmailIrwin();
                //item.email = "marcos.lima@newellco.com";
                //email.Add(item);

                //item = new listaEmailIrwin();
                //item.email = "kleber.silva@newellco.com";
                //email.Add(item);

                //item = new listaEmailIrwin();
                //item.email = "mario.pereira@newellco.com";
                //email.Add(item);

                //item = new listaEmailIrwin();
                //item.email = "marcelo.seeling@newellco.com";
                //email.Add(item);
                ...
                //item = new listaEmailIrwin();
                //item.email = "isaias@grupologos.com.br";
                //email.Add(item);

                //item = new listaEmailIrwin();
                //item.email = "jluis@grupologos.com.br";
                //email.Add(item);


                //item = new listaEmailIrwin();
                //item.email = "elima@grupologos.com.br";
                //email.Add(item);

                //item = new listaEmailIrwin();
                //item.email = "jcamargo@grupologos.com.br";
                //email.Add(item);

                //item = new listaEmailIrwin();
                //item.email = "idourado@grupologos.com.br";
                //email.Add(item);

                //item = new listaEmailIrwin();
                //item.email = "gestao.estoque@grupologos.com.br";
                //email.Add(item);

                //item = new listaEmailIrwin();
                //item.email = "mneto@grupologos.com.br";
                //email.Add(item);

                //item = new listaEmailIrwin();
                //item.email = "operacao.irwin@grupologos.com.br";
                //email.Add(item);

                //item = new listaEmailIrwin();
                //item.email = "ajesus@grupologos.com.br";
                //email.Add(item);
