...
namespace SistranBLL
{
    public sealed class Usuario
    {
        ...
        public static List<SistranMODEL.Usuario> Login_Alone2(string usuariologin,  string Conn, bool intranet)
        {
            try
            {
                ...
                {
                    //faz a busca do nome do banco no xml - 
                    List<SistranMODEL.Usuario> ILusuario = SistranDAO.Usuario.RetornaUsuarioLogin_Alone2(GetStringNoAccents(usuariologin),  Conn, intranet);
