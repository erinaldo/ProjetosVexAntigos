...
namespace SistranDAO
{
    public sealed class Arquivo
    {
        ...
        public void insertTeste()
        {
            ...
            {
                int m = int.Parse(Sistran.Library.GetDataTables.RetornarIdTabela("AB", Sistran.Library.Robo.Robo.RetornarStringBaseNovaLogos()));

                Sistran.Library.GetDataTables.ExecutarComandoSql("INSERT INTO AB VALUES (" + m.ToString() + ", 1, '1234')", HttpContext.Current.Session["ConnLogin"].ToString());
            }
