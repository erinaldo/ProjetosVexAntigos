...
namespace SistranDAO
{
    public sealed class Usuario
    {
        ...
        public static List<SistranMODEL.Usuario> RetornaUsuarioLogin_Alone(string usuariologin, string usuarioSenha, string Conn, bool intranet)
        {
            ...
            strsql.Append(" C.IdCliente IDCadastro,  ");
        ...
        public static List<SistranMODEL.Usuario> RetornaUsuarioLogin_Alone2(string usuariologin, string Conn, bool intranet)
        {
            StringBuilder strsql = new StringBuilder();
        ...
        {
            StringBuilder strsql = new StringBuilder();
            strsql.Append(" SELECT DISTINCT U.IDUsuario, U.Senha, U.IDCadastro, U.Login, U.Nome, EMAIL = CASE WHEN CTC.IDCadastroTipoDeContato = 1 THEN CCE.Endereco END, C.CnpjCpf, U.Ativo , U.IDPerfil, ");
        ...
        {
            public static void GravarLog(int idUser, string login, string acao, string PaginaProcesso, string conn)
            {
