<%@ Page Language="C#" MasterPageFile="~/SiteDetalheFull.master" AutoEventWireup="true"
    CodeFile="RelatorioProducaoRE_Resumo.aspx.cs" Inherits="RelatorioProducaoRE_Resumo" Title="Relatório de Produção por Relação de Entrega" %>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td width="50%" height="5" colspan="2">
                <table id="novatb" runat="server" __designer:mapid="a" cellpadding="1" 
                    cellspacing="0" class="table" width="100%">
                    <tr __designer:mapid="b" valign="baseline">
                        ...
                        <td __designer:mapid="1d" class="tdp" nowrap="nowrap" 
                            style="width: 60%" valign="bottom">
