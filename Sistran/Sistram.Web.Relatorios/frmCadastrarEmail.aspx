<%@ Page Language="C#" MasterPageFile="~/SiteDetalheFull.master" AutoEventWireup="true" EnableTheming="true" Theme="Adm"
    CodeFile="frmCadastrarEmail.aspx.cs" Inherits="frmCadastrarEmail" Title="Cadastrar Email" %>
    ...
    <telerik:RadGrid ID="RadGrid16" runat="server" AllowPaging="True" AllowSorting="True"
        ...
        <MasterTableView CellPadding="0" GridLines="Both" BorderColor="#CCCCCC" BorderWidth="1px">
            ...
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="Reports" EmptyDataText="&amp;nbsp;" HeaderText="Relatorios"
                    UniqueName="columnm" Visible="true">
                </telerik:GridBoundColumn>
                                ...
                                <table style="width: 400px">
                                    ...
                                    <tr>
                                        <td valign="top">
                                            Relatórios:</td>
                                        <td>
                                            <asp:CheckBoxList ID="chkReports" runat="server" RepeatColumns="1">
                                                <asp:ListItem>SITUACAO DE ENTREGA</asp:ListItem>
                                                <asp:ListItem>FLUXO DE CAIXA</asp:ListItem>
                                                <asp:ListItem>RELATORIO DE PRODUCAO POR RELACAO DE ENTREGA</asp:ListItem>
                                                <asp:ListItem>PAINEL DE FATURAMENTO</asp:ListItem>
                                                <asp:ListItem>OPERACAO CLIENTE</asp:ListItem>
                                            </asp:CheckBoxList>
                                        </td>
                                    </tr>
                                    <tr>
