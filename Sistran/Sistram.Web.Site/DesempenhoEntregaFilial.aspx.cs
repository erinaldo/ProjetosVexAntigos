...
public partial class DesempenhoEntregaFilial : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (!IsPostBack)
            {
                ...
                btnGerarReport.Attributes.Add("onClick", "window.open('frmRptDesempenhoFilial.aspx?n="+  Guid.NewGuid() +"&tipo=TELA&tit=" + Server.UrlEncode(Request.QueryString["opc"].ToString()) + "', 'NovaJanela2', 'yes')");
                btnPDF.Attributes.Add("onClick", "window.open('frmRptDesempenhoFilial.aspx?tipo=PDF&tit=" + Server.UrlEncode(Request.QueryString["opc"].ToString()) + "', 'NovaJanela22', 'yes')");
    ...
    protected void MontarTable()
    {
        ...
        DataTable dt = NotasFiscais.ListarDesempenhoEntregaFilial(Convert.ToDateTime(txtI.Text), Convert.ToDateTime(txtF.Text), Sistran.Library.FuncoesUteis.retornarClientesResumoFilial(false), Session["Conn"].ToString());
