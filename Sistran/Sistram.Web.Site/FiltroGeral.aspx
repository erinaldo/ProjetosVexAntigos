<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="FiltroGeral.aspx.cs"
    Inherits="FiltroGeral" Theme="Adm" EnableTheming="true" %>
        ...
        <table id="novatb" class="table" runat="server" cellpadding="1" cellspacing="0" width="100%">
            ...
            <tr valign="baseline">
                ...
                <td class="tdp" nowrap="nowrap" valign="middle">
                    ...
                    <span style="font-size: 7pt">Até1:</span><asp:TextBox ID="txtF" runat="server" CssClass="txtPesquisa"
