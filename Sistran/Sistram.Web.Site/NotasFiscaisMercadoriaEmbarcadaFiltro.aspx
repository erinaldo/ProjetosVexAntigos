<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="NotasFiscaisMercadoriaEmbarcadaFiltro.aspx.cs"
    Inherits="NotasFiscaisMercadoriaEmbarcadaFiltro" Theme="Adm" EnableTheming="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="Server">
    <asp:Panel ID="pnlteste" runat="server" DefaultButton="Button1">
        <table style="width: 100%;" border="0" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td style="background-image: url('Images/skins/primeiro/img/menu_3_2.jpg'); height: 25px;
                    font-size: 8pt; font-weight: bold; text-align: right;" width="1%">
                    Exibir:
                </td>
                <td style="background-image: url('Images/skins/primeiro/img/menu_3_2.jpg'); height: 20px;
        ...
        <table id="novatb" class="table" runat="server" cellpadding="0" cellspacing="0" visible="false"
            width="100%">
            <tr valign="middle">
                ...
                <td class="td" width="1%" align="right" style="font-size: 8pt; font-weight: bold;
                    font-family: arial">
                    Exibir:
                </td>
            </tr>
            <tr valign="middle">
                ...
                <td class="td" id="tdBot" runat="server">
        ...
        <asp:UpdatePanel ID="xxwewx" runat="server">
            <ContentTemplate>
                <table width="100%">
                    <tr align="right">
                        <td>
                            <asp:Button ID="btnGerarReport" runat="server" CssClass="button" Text="Relatório"
                                Width="60px" />
                            <label id="lblsep" runat="server" style="width: 10px">
                                &nbsp;</label>
                            <asp:Button ID="btnPDF" runat="server" CssClass="button" Text="PDF" Visible="False"
                                Width="40px" />
                        </td>
                    </tr>
                </table>
                <telerik:RadGrid ID="RadGrid16" runat="server" AllowPaging="True" AllowSorting="True"
                    ...
                    OnSortCommand="RadGrid1_SortCommand" Width="99%" OnItemDataBound="RadGrid1_ItemDataBound"
                    CellPadding="0" Skin="Default2006">
                    <MasterTableView CellPadding="0" GridLines="Both" BorderColor="#CCCCCC" BorderWidth="1px">
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn DataField="Serie" EmptyDataText="&amp;nbsp;" HeaderStyle-HorizontalAlign="Center"
                                HeaderText="Série" ItemStyle-HorizontalAlign="Center" UniqueName="column5" Visible="false">
                            ...
                            <telerik:GridBoundColumn DataField="DataDeSaida" DataFormatString="{0:dd/MM/yyyy}"  Visible="false"
                                EmptyDataText="&amp;nbsp;" HeaderStyle-HorizontalAlign="Center" HeaderText="Saída"
