<%@ Page Language="C#" MasterPageFile="~/SiteDetalhe.master" AutoEventWireup="true" CodeFile="detFaturamentoLinhasExpedidas.aspx.cs"
    Inherits="detFaturamentoLinhasExpedidas" Theme="Adm" EnableTheming="true" %>
                        ...
                        <tr>
                            <td style="background-image: url('../Images/skins/primeiro/img/menu_3_2.jpg'); height: 25px">
                                <asp:Label ID="lblTitulo" runat="server" Font-Bold="True" Font-Size="14px" 
                                    Text="Linhas Expedidas"></asp:Label>
                            </td>
                        </tr>
                    </table>
                    <br />
