...
public partial class frmAcompanhamento : System.Web.UI.Page
{
    ...
    protected void MontarTable(DataTable dt)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            PlaceHolder1.Controls.Add(new LiteralControl(@"<td class='tdpCabecalho' align='center' style='font-size:7pt;width:1%;'>"));
            ...
            foreach (DataRow item in dt.Rows)
            {
                ...
                if (item["UltimaSincronizacao"].ToString() == "" && item["IDRASTREAMENTO"].ToString()=="0" )
                    PlaceHolder1.Controls.Add(new LiteralControl(@"<td class='tdp' align='center' style='font-size:7pt;height:10px;font-weight:normal;width:1%'> &nbsp;"));
                else
                    PlaceHolder1.Controls.Add(new LiteralControl(@"<td class='tdp' align='center' style='font-size:7pt;height:10px;font-weight:normal;width:1%'><img src='celular.jpg' style='hiegth:10px' alt='Efetuado Por Mobilidade' alternateText='Efetuado Por Mobilidade'>"));
