<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frmAcompanhamentoInterno.aspx.cs"
    Inherits="frmAcompanhamentoInterno" Theme="Adm" EnableTheming="true" %>
                    ...
                    <table class="grid" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td nowrap="nowrap" valign="top" width="1%">
                                <asp:Label ID="lblMapaNota1" runat="server" Font-Bold="True" Font-Names="Arial" 
                                    Font-Size="12pt" Text="Última Localização dos Veículos em Rota"></asp:Label>
                            </td>
                            <td style="text-align: left" valign="top" width="99%">
                                <asp:Label ID="LblListaNf" runat="server" Font-Bold="True" Font-Names="Arial" 
                                    Font-Size="12pt" Text="Notas Fiscais" Visible="False"></asp:Label>
                            </td>
                            <td style="text-align: left" valign="top" width="1%">
                                <asp:Label ID="lblMapaNota" runat="server" Font-Bold="True" Font-Names="Arial" 
                                    Font-Size="12pt" Text="Localização NF" Visible="False"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td valign="top">
                                <cc1:GMap ID="GMap1" runat="server" enableGoogleBar="True" GZoom="14" 
                                    Height="400px" mapType="Normal" Width="550px" />
                            </td>
                            <td valign="top">
                                <asp:ListBox ID="ListBox1" runat="server" AutoPostBack="True" 
                                    CssClass="listbox" Font-Names="Arial" Font-Size="8pt" Height="200px" 
                                    onselectedindexchanged="ListBox1_SelectedIndexChanged" Visible="False" 
                                    Width="99%"></asp:ListBox>
                                    ...
                                    <Columns>
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:LinkButton ID="LinkButton1" runat="server" CssClass="link" 
                                                    Font-Bold="True" CommandArgument="ver" CommandName='<% # Eval("IDDOCUMENTO") %>'>Ver</asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <ItemStyle HorizontalAlign="Center" />
                                         ...
                                         <asp:TemplateField >
                                            ...
                                            <ItemTemplate >
                                                <asp:LinkButton ID="lbkFoto" runat="server" CssClass="link" 
                                                    Font-Bold="True" CommandArgument="VerFoto" CommandName='<% # Eval("IDDOCUMENTO") %>' Text='<%# Bind("FOTO") %>'></asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
                            ...
                            <td valign="top">
                                <cc1:GMap ID="GMap2" runat="server" enableGoogleBar="True" GZoom="14" 
                                    Height="400px" mapType="Normal" Visible="False" Width="550px" />
                                &nbsp;
                            </td>
                        </tr>
                    </table>
