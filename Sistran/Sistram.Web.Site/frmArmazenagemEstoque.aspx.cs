...
public partial class frmArmazenagemEstoque : System.Web.UI.Page
{
    ...
    protected void MontarTable()
    {
        ...
        strsql += " SELECT DATA, M3ARMAZENAGEM, M3ENTRADA, M3SAIDA  FROM MOVIMENTACAOCLIENTECONSOLIDADO   WHERE DATA BETWEEN CONVERT(DATETIME, '" + txtI.Text + "',103)  AND CONVERT(DATETIME, '" + txtF.Text + "',103)    AND IDCLIENTE=" + ILusuario[0].EmpresaId;
        ...
        PlaceHolder1.Controls.Add(new LiteralControl(@"<td class='tdpCabecalho' align='left' nowrap=nowrap style='font-size:7pt;font-weight:bold'>" + ILusuario[0].RazaoSocialNome));
        PlaceHolder1.Controls.Add(new LiteralControl(@"</td>"));
    ...
    private void gerarGrafico(DataTable dt)
    {
        ...
        cr.Series[2].LabelForeColor = System.Drawing.Color.DarkRed;
        cr.Series[2].Color = System.Drawing.Color.DarkRed;
        ...
        cr.Series[1].Points.DataBindXY(dias, entradas);
        cr.Series[2].Points.DataBindXY(dias, saidas);
