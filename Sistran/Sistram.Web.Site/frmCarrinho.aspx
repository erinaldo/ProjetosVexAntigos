<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frmCarrinho.aspx.cs"
    Inherits="frmCarrinho" Title="Untitled Page" EnableEventValidation="false" %>
                    ...
                    <tr>
                        <td width="99%" style="text-align: right">
                            ...
                            &nbsp;<asp:Button ID="btnContinuarComprando" runat="server" CssClass="button" OnClick="Button2_Click"
                                Text="INCLUIR MAIS ITENS" Width="120px" />
                            &nbsp;&nbsp;
                        </td>
                    </tr>
                </table>
