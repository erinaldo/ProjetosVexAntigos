<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frmKPI.aspx.cs"
    Inherits="frmKPI" Theme="Adm" EnableTheming="true" %>
            ...
            <tr valign="baseline">
                ...
                <td class="tdp" valign="1%">
                    <asp:DropDownList ID="cboTipoRem" runat="server" CssClass="cbo" 
                        Font-Names="Arial" Font-Size="7pt" Height="17px" Enabled="False" 
                        Visible="False">
        ...
        <table align="center" style="width: 100%">
            <tr>
                <td style="text-align: center">
                    <asp:Panel ID="Panel3" runat="server" HorizontalAlign="Center" Width="1000px">
                        <table style="width: 100%">
                            <tr>
                                <td class="tdpCenter" valign="top" width="25%">
