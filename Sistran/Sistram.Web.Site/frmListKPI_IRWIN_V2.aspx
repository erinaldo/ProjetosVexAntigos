<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frmListKPI_IRWIN_V2.aspx.cs"
    Inherits="frmListKPI_IRWIN_V2" Theme="Adm" EnableTheming="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="Server">
    ...
    <asp:Panel ID="pnlteste" runat="server" DefaultButton="Button1">
        ...
        <asp:UpdatePanel ID="xxwewx" runat="server">
            <ContentTemplate>
                <asp:GridView ID="grdResultado" runat="server" AutoGenerateColumns="False" CellPadding="4" 
                    ForeColor="#333333" OnRowDataBound="grdResultado_RowDataBound" 
                    ...
                    <RowStyle BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" 
                        Width="99%" BackColor="#EFF3FB" />
                    <AlternatingRowStyle BackColor="White" />
                    <Columns>
         
               
                        <asp:BoundField DataField="CHAVE" />
                        ...
                        <asp:BoundField DataField="DescricaoUnidadeDeMedida">
                            <HeaderStyle HorizontalAlign="Left" />
                            <ItemStyle Wrap="False" />
                        </asp:BoundField>
                        <asp:BoundField DataField="DescricaoTarguet">
                            <HeaderStyle HorizontalAlign="Left" />
                            <ItemStyle Wrap="False" />
                        </asp:BoundField>
