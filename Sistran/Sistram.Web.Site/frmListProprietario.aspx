<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frmListProprietario.aspx.cs" Inherits="Intranet_frmListProprietario" EnableTheming="True" Theme="Adm" %>
            ...
            <tr valign="bottom">
                ...
                <td class="tdp" nowrap="nowrap" width="1%">
                    <asp:Button ID="Button1" runat="server" CssClass="button" Font-Names="arial" 
                        Font-Size="7pt" OnClick="Button1_Click" Text="Pesquisar" Width="100px" />
                    &nbsp;<asp:Button ID="Button2" runat="server" CssClass="button" Font-Names="arial" 
                        Font-Size="7pt" onclick="Button2_Click" Text="Novo" Width="100px" />
                </td>
               
                <td class="tdp" nowrap="nowrap" width="80%">
                    &nbsp;</td>
                <td class="tdp" nowrap="nowrap" width="90%"></td>
            </tr>
        </table>
                    ...
                    <MasterTableView AutoGenerateColumns="False">
                        ...
                        <Columns>
                            <telerik:GridTemplateColumn HeaderText="Código" UniqueName="TemplateColumn">
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink1" runat="server" Text='<%# Bind("IDCADASTRO") %>' NavigateUrl='<% # "frmCadProprietario.aspx?IDCADASTRO=" + Eval("IDCADASTRO") %>'></asp:HyperLink>
                                </ItemTemplate>
