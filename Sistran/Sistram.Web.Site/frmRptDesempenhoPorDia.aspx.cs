...
public partial class frmRptDesempenhoPorDia : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //    SistranBLL.Usuario.LogBDBLL.GravarLog(ILusuario[0].UsuarioId, ILusuario[0].Login, "GEROU O RELATÓRIO DESEMPENHO POR DIA", System.IO.Path.GetFileName(HttpContext.Current.Request.FilePath), Session["Conn"].ToString());
