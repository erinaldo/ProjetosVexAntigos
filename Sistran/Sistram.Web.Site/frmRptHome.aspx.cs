...
public partial class frmRptHome : System.Web.UI.Page
{
    ...
    //    SistranBLL.Usuario.LogBDBLL.GravarLog(ILusuario[0].UsuarioId, ILusuario[0].Login, "GEROU O RELATÓRIO DA HOME", System.IO.Path.GetFileName(HttpContext.Current.Request.FilePath),  Session["Conn"].ToString());

    //    Label1.Text = Sistran.Library.FuncoesUteis.retornarClientes();
    ...
    //    DataTable dtAgEmb = NotasFiscais.ListarHomeAguardandoEmbarque(Sistran.Library.FuncoesUteis.retornarClientes(), Session["Conn"].ToString(), FuncoesGerais.LoadDataSetConstantes("ConstDcoFilSitAguardEmbarque"), ini, fim);
    //    DataTable dtAgEmbFilial =NotasFiscais.ListarHomeAguardandoEmbarqueFilial(Sistran.Library.FuncoesUteis.retornarClientes(), Session["Conn"].ToString(), FuncoesGerais.LoadDataSetConstantes("ConstDcoFilSitAguardEmbarque"), ini, fim );
    //    DataTable dtEmb = NotasFiscais.ListarHomeNotasFiscaisEmbarcadas(Sistran.Library.FuncoesUteis.retornarClientes(), Session["Conn"].ToString(), FuncoesGerais.LoadDataSetConstantes("ConstDcoFilSitMercadoriaEmbarcada"), ini, fim);
    //    DataTable dtOcorr = NotasFiscais.ListarHomeNotasFiscaisComOcorrencias(Sistran.Library.FuncoesUteis.retornarClientes(), Session["Conn"].ToString(), ini, fim, false, false);
