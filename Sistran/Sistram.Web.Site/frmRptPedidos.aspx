<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="frmRptPedidos.aspx.cs"
    Inherits="frmRptPedidos" Theme="Adm" EnableTheming="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="Server">
    ...
    <asp:Panel ID="Panel1" runat="server" Height="400px">
        <table border="1" class="table" cellpadding="0" cellspacing="0" style="height:399px" >
        <tr valign="top">
        <td align="center" valign="top" style="font-size:8pt; height:20px" class="tdpCabecalho" > Selecione um Destinatário </td>
        </tr>
            <tr valign="top">
                <td>
                ...
                <table id="novatb" class="table" runat="server" cellpadding="1" cellspacing="1" width="100%"
                    ...
                    <tr valign="bottom">
                        ...
                        <td class="tdp" nowrap="nowrap">
                            ...
                            &nbsp;Até:<asp:TextBox ID="txtF" runat="server" CssClass="txt" Width="60px"></asp:TextBox>
                        </td>
                                                ...
                                                <MasterTableView>
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <telerik:GridBoundColumn DataField="CODIGO" EmptyDataText="&amp;nbsp;" 
                                                            HeaderText="CÓDIGO" UniqueName="column2" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" HeaderStyle-Font-Bold="false" >
                                                            
                                                        </telerik:GridBoundColumn>
                                                        
                                                        <telerik:GridBoundColumn DataField="Descricao" EmptyDataText="&amp;nbsp;" 
                                                            HeaderText="DESCRIÇÃO" UniqueName="column3" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" HeaderStyle-Font-Bold="false" >
                                                        </telerik:GridBoundColumn>
                                                        ...
                                                        <telerik:GridBoundColumn DataField="CNPJCPF_DESTINATARIO" 
                                                            EmptyDataText="&amp;nbsp;" HeaderText="CNPJ DESTINATÁRIO" UniqueName="column5" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" HeaderStyle-Font-Bold="false" >
                                                        </telerik:GridBoundColumn>
                                                        <telerik:GridBoundColumn DataField="DESTINATARIO" EmptyDataText="&amp;nbsp;" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" HeaderStyle-Font-Bold="false" 
                                                            HeaderText="NOME DESTINATÁRIO" UniqueName="column">
                                                        </telerik:GridBoundColumn>
                                                    </Columns>
                                                </MasterTableView>
