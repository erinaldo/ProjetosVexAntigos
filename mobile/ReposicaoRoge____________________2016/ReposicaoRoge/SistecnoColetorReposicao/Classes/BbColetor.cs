...
namespace SistecnoColetor.Classes
{
    public static class BbColetor
    {
        ...
        public static string RetornarConexao()
        {
        ...
        public static void Excuta(string sql, SqlCeConnection cnn)
        {
            //SqlCeConnection cnn = new SqlCeConnection(RetornarConexao());
            SqlCeCommand cmd = new SqlCeCommand();
        ...
        public static string  RetornarScalar(string sql, SqlCeConnection cnn)
        {
            //SqlCeConnection cnn = new SqlCeConnection(RetornarConexao());
            SqlCeCommand cmd = new SqlCeCommand();
            DataSet ds = new DataSet();
