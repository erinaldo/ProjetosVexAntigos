...
namespace SistecnoColetor.Classes.DAL
{
    public class Documento
    {
        public DataTable retornarConferenciaByChave(string chave)
        {
            ...
            sql += " WHERE TIPODEDOCUMENTO  ='NOTA FISCAL' AND IDFILIAl = " + VarGlobal.Usuario.UltimaFilial + " AND DOCUMENTODOCLIENTE4='" + chave + "'";
    ...
    public class DepositoPlantaLocalizacao
    {
        ...
        public DataTable RetornarEndereco(string idProdutoCliente)
        {
            ...
            sql += " order by DPL.ORDEMARMAZENAGEM, DPL.CODIGO, LT.VALIDADE ";
            return BdExterno.RetornarDT(sql, VarGlobal.Conexao);
        }
    }
    ...
    public class UnidadeDeArmazenagem
    {
        ...
        {
            //string sql = "UPDATE UNIDADEDEARMAZENAGEM SET IDDEPOSITOPLANTALOCALIZACAO =(SELECT ISNULL(IDDEPOSITOPLANTALOCALIZACAO,0) FROM PRODUTOCLIENTE WHERE IDPRODUTOCLIENTE = " + idproducliente + ") WHERE IDUNIDADEDEARMAZENAGEM = (SELECT IDUNIDADEDEARMAZENAGEM FROM UNIDADEDEARMAZENAGEM WHERE  IDDEPOSITOPLANTALOCALIZACAO = " + IdDepositoPlantaLocalizacaoOrigem + ")";
    ...
    public class Movimentacao
    {
                                        ...
                                        string IdProdutoCliente)
        {
            ...
            try
            {
                ...
                sql = "UPDATE UNIDADEDEARMAZENAGEM SET STATUS='RECEBIDO' WHERE IDUnidadeDeArmazenagem= " + IdUa;
                Comm.CommandText = sql;
                Comm.ExecuteNonQuery();
                #endregion
                trans.Commit();
        ...
        public void GravarMovimentacao(
                                       ...
                                       string IdOperacaoColetor,
                                       string EntradaSaida,
                                       string IdProdutoCliente, string  GravarUA)
        {
